...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_05JJA_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_06JAS_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_08JASOND_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_07JJASON_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_01DJF_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_02JFM_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_03DJFMAM_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_04JFMAMJ_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_09DN_DIFF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_AVG_10JD_DIFF_outside','-dpng')
close all
%% END ETAN
