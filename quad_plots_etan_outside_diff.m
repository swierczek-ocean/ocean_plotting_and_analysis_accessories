...
acc_quad_plots_v8
hold off
print('ETAN_AVG_JASOND_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_DJFMAM_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_JFMAMJ_DIFF','-dpng')
close all
%% END ETAN
