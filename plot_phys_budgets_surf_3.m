...
load hpc/Budgets3_60m carbon_surf3 heat_surf3
load hpc/Budgets6_60m carbon_surf6 heat_surf6
load hpc/Budgets12_60m carbon_surf12 heat_surf12
acc_colors
lw = 2.9;
c3 = 55;
c6 = 56;
...
legend([h10(1),h11(1),h12(1)],...
    '1/3 mean: 0.067 PW','1/6 mean: 0.065 PW','1/12 mean: 0.025 PW',...
...
legend([h10(1),h11(1),h12(1)],...
    '1/3 mean: 0.22 Gt C/yr','1/6 mean: 0.23 Gt C/yr','1/12 mean: 0.23 Gt C/yr',...
    'Location','southeast','FontSize',20)
hold off
set(gcf,'InvertHardCopy','off'); print('-r200','Budgets/AB_BUDGETS_surf_heat_DIC_shelf','-dpng')
