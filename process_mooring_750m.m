...
Obs_750_temp = [time,lat,lon+360,theta,salt];
Obs_750_temp = sortrows(Obs_750_temp,1);

start_date = 20161130;

start = find(Obs_750_temp(:,1)>start_date,1);

Obs_750_temp = Obs_750_temp(start:end,:);
...
for ii=1:396
    ...
    Obs_750(ii,:) = mean(Obs_750_temp(Obs_750_temp(:,1)==date_n,:),1);
    date = date+1;
end

clearvars -except Obs_750
