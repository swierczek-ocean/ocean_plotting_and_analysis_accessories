...
acc_quad_plots_v8
hold off
print('ETAN_AVG_05JJA_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_06JAS_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_08JASOND_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_07JJASON_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_01DJF_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_02JFM_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_03DJFMAM_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_04JFMAMJ_DIFF','-dpng')
close all
%% END ETAN
