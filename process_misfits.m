...
load PROFILES/THETA_USGO_WO_2017_PFL_D_3
...
save PROFILES/processed/theta_mf_3 theta_mf_3

clear

load PROFILES/THETA_USGO_WO_2017_PFL_D_6
...
save PROFILES/processed/theta_mf_6 theta_mf_6

clear

load PROFILES/THETA_USGO_WO_2017_PFL_D_12
...
save PROFILES/processed/theta_mf_12 theta_mf_12

clear

load PROFILES/DIC_VIZ_SO_2017_PFL_3
ufac=1e6/1024.5;
nn = length(prof_lat);
...
save PROFILES/processed/dic_mf_3 dic_mf_3

clear

load PROFILES/DIC_VIZ_SO_2017_PFL_6
ufac=1e6/1024.5;
nn = length(prof_lat);
...
save PROFILES/processed/dic_mf_6 dic_mf_6

clear

load PROFILES/DIC_VIZ_SO_2017_PFL_12
ufac=1e6/1024.5;
nn = length(prof_lat);
...
save PROFILES/processed/dic_mf_12 dic_mf_12
...
save PROFILES/processed/theta_mfn_3 theta_mfn_3
...
save PROFILES/processed/theta_mfn_6 theta_mfn_6
...
save PROFILES/processed/theta_mfn_12 theta_mfn_12
...
save PROFILES/processed/dic_mfn_3 dic_mfn_3
...
save PROFILES/processed/dic_mfn_6 dic_mfn_6
...
save PROFILES/processed/dic_mfn_12 dic_mfn_12
