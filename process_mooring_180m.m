...
Obs_180_temp = [time,lat,lon+360,theta,salt];
Obs_180_temp = sortrows(Obs_180_temp,1);

start_date = 20161130;

start = find(Obs_180_temp(:,1)>start_date,1);

Obs_180_temp = Obs_180_temp(start:end,:);
...
for ii=1:396
    ...
    Obs_180(ii,:) = mean(Obs_180_temp(Obs_180_temp(:,1)==date_n,:),1);
    date = date+1;
end

clearvars -except Obs_180
