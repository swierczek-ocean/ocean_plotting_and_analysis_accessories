...
parfor ii=1:384
    for jj=1:260
        if (HC(ii,jj,1)==0)
            THETA_Series_vert_62(ii,jj,:) = NaN;
            THETA_Series_vert_t62(ii,jj,:) = NaN;
            THETA_Series_vert100_t62(ii,jj,:) = NaN;
            DIC_Series_vert_62(ii,jj,:) = NaN;
            DIC_Series_vert_t62(ii,jj,:) = NaN;
            DIC_Series_vert100_t62(ii,jj,:) = NaN;
            O2_Series_vert_62(ii,jj,:) = NaN;
            O2_Series_vert_t62(ii,jj,:) = NaN;
            O2_Series_vert100_t62(ii,jj,:) = NaN;
            NO3_Series_vert_62(ii,jj,:) = NaN;
            NO3_Series_vert_t62(ii,jj,:) = NaN;
            NO3_Series_vert100_t62(ii,jj,:) = NaN;
        end
    end
end
...
ETAN_62_DJF_slice_avg = mean(ETAN_Series_slice_62(:,1:91),2);
MLD_62_DJF_slice_avg = mean(MLD_Series_slice_62(:,1:91),2);
PCO2_62_DJF_slice_avg = mean(PCO2_Series_slice_62(:,1:91),2);
TFLUX_62_DJF_slice_avg = mean(TFLUX_Series_slice_62(:,1:91),2);
SFLUX_62_DJF_slice_avg = mean(SFLUX_Series_slice_62(:,1:91),2);
CFLUX_62_DJF_slice_avg = mean(CFLUX_Series_slice_62(:,1:91),2);
OFLUX_62_DJF_slice_avg = mean(OFLUX_Series_slice_62(:,1:91),2);
...
ETAN_62_JFM_slice_avg = mean(ETAN_Series_slice_62(:,32:122),2);
MLD_62_JFM_slice_avg = mean(MLD_Series_slice_62(:,32:122),2);
PCO2_62_JFM_slice_avg = mean(PCO2_Series_slice_62(:,32:122),2);
TFLUX_62_JFM_slice_avg = mean(TFLUX_Series_slice_62(:,32:122),2);
SFLUX_62_JFM_slice_avg = mean(SFLUX_Series_slice_62(:,32:122),2);
CFLUX_62_JFM_slice_avg = mean(CFLUX_Series_slice_62(:,32:122),2);
OFLUX_62_JFM_slice_avg = mean(OFLUX_Series_slice_62(:,32:122),2);
...
ETAN_62_DJFMAM_slice_avg = mean(ETAN_Series_slice_62(:,1:182),2);
MLD_62_DJFMAM_slice_avg = mean(MLD_Series_slice_62(:,1:182),2);
PCO2_62_DJFMAM_slice_avg = mean(PCO2_Series_slice_62(:,1:182),2);
TFLUX_62_DJFMAM_slice_avg = mean(TFLUX_Series_slice_62(:,1:182),2);
SFLUX_62_DJFMAM_slice_avg = mean(SFLUX_Series_slice_62(:,1:182),2);
CFLUX_62_DJFMAM_slice_avg = mean(CFLUX_Series_slice_62(:,1:182),2);
OFLUX_62_DJFMAM_slice_avg = mean(OFLUX_Series_slice_62(:,1:182),2);
...
ETAN_62_JFMAMJ_slice_avg = mean(ETAN_Series_slice_62(:,32:213),2);
MLD_62_JFMAMJ_slice_avg = mean(MLD_Series_slice_62(:,32:213),2);
PCO2_62_JFMAMJ_slice_avg = mean(PCO2_Series_slice_62(:,32:213),2);
TFLUX_62_JFMAMJ_slice_avg = mean(TFLUX_Series_slice_62(:,32:213),2);
SFLUX_62_JFMAMJ_slice_avg = mean(SFLUX_Series_slice_62(:,32:213),2);
CFLUX_62_JFMAMJ_slice_avg = mean(CFLUX_Series_slice_62(:,32:213),2);
OFLUX_62_JFMAMJ_slice_avg = mean(OFLUX_Series_slice_62(:,32:213),2);
...
ETAN_62_DN_slice_avg = mean(ETAN_Series_slice_62(:,1:364),2);
MLD_62_DN_slice_avg = mean(MLD_Series_slice_62(:,1:364),2);
PCO2_62_DN_slice_avg = mean(PCO2_Series_slice_62(:,1:364),2);
TFLUX_62_DN_slice_avg = mean(TFLUX_Series_slice_62(:,1:364),2);
SFLUX_62_DN_slice_avg = mean(SFLUX_Series_slice_62(:,1:364),2);
CFLUX_62_DN_slice_avg = mean(CFLUX_Series_slice_62(:,1:364),2);
OFLUX_62_DN_slice_avg = mean(OFLUX_Series_slice_62(:,1:364),2);
...
ETAN_62_JD_slice_avg = mean(ETAN_Series_slice_62(:,32:395),2);
MLD_62_JD_slice_avg = mean(MLD_Series_slice_62(:,32:395),2);
PCO2_62_JD_slice_avg = mean(PCO2_Series_slice_62(:,32:395),2);
TFLUX_62_JD_slice_avg = mean(TFLUX_Series_slice_62(:,32:395),2);
SFLUX_62_JD_slice_avg = mean(SFLUX_Series_slice_62(:,32:395),2);
CFLUX_62_JD_slice_avg = mean(CFLUX_Series_slice_62(:,32:395),2);
OFLUX_62_JD_slice_avg = mean(OFLUX_Series_slice_62(:,32:395),2);
...
parfor ii=1:m62
    for jj=1:n62
        if (HC(slice_index,ii,jj)==0)
            THETA_Series_slice_62(ii,jj,:) = NaN;
            SALT_Series_slice_62(ii,jj,:) = NaN;
            WVEL_Series_slice_62(ii,jj,:) = NaN;
            UVEL_Series_slice_62(ii,jj,:) = NaN;
            VVEL_Series_slice_62(ii,jj,:) = NaN;
            DIC_Series_slice_62(ii,jj,:) = NaN;
            ALK_Series_slice_62(ii,jj,:) = NaN;
            O2_Series_slice_62(ii,jj,:) = NaN;
            NO3_Series_slice_62(ii,jj,:) = NaN;
            
            THETA_62_DJF_slice_avg(ii,jj) = NaN;
            SALT_62_DJF_slice_avg(ii,jj) = NaN;
            DIC_62_DJF_slice_avg(ii,jj) = NaN;
            ALK_62_DJF_slice_avg(ii,jj) = NaN;
            WVEL_62_DJF_slice_avg(ii,jj) = NaN;
            VVEL_62_DJF_slice_avg(ii,jj) = NaN;
            UVEL_62_DJF_slice_avg(ii,jj) = NaN;
            O2_62_DJF_slice_avg(ii,jj) = NaN;
            NO3_62_DJF_slice_avg(ii,jj) = NaN;
            
            THETA_62_JFM_slice_avg(ii,jj) = NaN;
            SALT_62_JFM_slice_avg(ii,jj) = NaN;
            DIC_62_JFM_slice_avg(ii,jj) = NaN;
            ALK_62_JFM_slice_avg(ii,jj) = NaN;
            WVEL_62_JFM_slice_avg(ii,jj) = NaN;
            VVEL_62_JFM_slice_avg(ii,jj) = NaN;
            UVEL_62_JFM_slice_avg(ii,jj) = NaN;
            O2_62_JFM_slice_avg(ii,jj) = NaN;
            NO3_62_JFM_slice_avg(ii,jj) = NaN;
            
            THETA_62_DJFMAM_slice_avg(ii,jj) = NaN;
            SALT_62_DJFMAM_slice_avg(ii,jj) = NaN;
            DIC_62_DJFMAM_slice_avg(ii,jj) = NaN;
            ALK_62_DJFMAM_slice_avg(ii,jj) = NaN;
            WVEL_62_DJFMAM_slice_avg(ii,jj) = NaN;
            VVEL_62_DJFMAM_slice_avg(ii,jj) = NaN;
            UVEL_62_DJFMAM_slice_avg(ii,jj) = NaN;
            O2_62_DJFMAM_slice_avg(ii,jj) = NaN;
            NO3_62_DJFMAM_slice_avg(ii,jj) = NaN;
            
            THETA_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            SALT_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            DIC_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            ALK_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            WVEL_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            VVEL_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            UVEL_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            O2_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            NO3_62_JFMAMJ_slice_avg(ii,jj) = NaN;
            
            THETA_62_DN_slice_avg(ii,jj) = NaN;
            SALT_62_DN_slice_avg(ii,jj) = NaN;
            DIC_62_DN_slice_avg(ii,jj) = NaN;
            ALK_62_DN_slice_avg(ii,jj) = NaN;
            WVEL_62_DN_slice_avg(ii,jj) = NaN;
            VVEL_62_DN_slice_avg(ii,jj) = NaN;
            UVEL_62_DN_slice_avg(ii,jj) = NaN;
            O2_62_DN_slice_avg(ii,jj) = NaN;
            NO3_62_DN_slice_avg(ii,jj) = NaN;
            
            THETA_62_JD_slice_avg(ii,jj) = NaN;
            SALT_62_JD_slice_avg(ii,jj) = NaN;
            DIC_62_JD_slice_avg(ii,jj) = NaN;
            ALK_62_JD_slice_avg(ii,jj) = NaN;
            WVEL_62_JD_slice_avg(ii,jj) = NaN;
            VVEL_62_JD_slice_avg(ii,jj) = NaN;
            UVEL_62_JD_slice_avg(ii,jj) = NaN;
            O2_62_JD_slice_avg(ii,jj) = NaN;
            NO3_62_JD_slice_avg(ii,jj) = NaN;
        end
    end
end
