...
dH1_3 = 100.*(ssh3p - ssh3c);
dH2_3 = 100.*(ssh3n - ssh3c);

dH1_12 = 100.*(ssh12p - ssh12c);
dH2_12 = 100.*(ssh12n - ssh12c);
...
axis(inside_coords)
ytickformat('degrees')
title('1/3 LIN RESPONSE SSH [cm]','FontWeight','Normal','FontSize',16)
acc_movie_w
acc_quad_movies(1)
...
xtickformat('degrees')
ytickformat('degrees')
title('1/3 NONLIN RESPONSE SSH [cm]','FontWeight','Normal','FontSize',16)
acc_movie_w
acc_quad_movies(2)
text(291,-33.7,datestr(numdate,'yyyy mmm dd'),'FontSize',21,'Color','w')
hold off
...
xtickformat('degrees')
ytickformat('degrees')
title('1/12 LIN RESPONSE SSH [cm]','FontWeight','Normal','FontSize',16)
acc_movie_w
acc_quad_movies(3)
text(291,-33.7,datestr(numdate,'yyyy mmm dd'),'FontSize',21,'Color','w')
hold off
...
xtickformat('degrees')
ytickformat('degrees')
title('1/12 NONLIN RESPONSE SSH [cm]','FontWeight','Normal','FontSize',16)
acc_movie_w
acc_quad_movies(4)
text(291,-33.7,datestr(numdate,'yyyy mmm dd'),'FontSize',21,'Color','w')
hold off
...
vidObj = VideoWriter('sm_movie_SSH_pert.avi');
vidObj.Quality = 100;
vidObj.FrameRate = 10;
open(vidObj);
