...
%% top of AB
arrow([307.5,-34.9],[307.5,-37.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
...
arrow([327.5,-34.9],[327.5,-37.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
h3 = arrow([327.5,-35],[327.5,-37.5],20,'BaseAngle',90,'Color',Color(c12,:),'LineWidth',qw);
%% 

%% bottom of AB
arrow([307.5,-50.9],[307.5,-53.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
...
arrow([327.5,-50.9],[327.5,-53.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
arrow([327.5,-51],[327.5,-53.5],20,'BaseAngle',90,'Color',Color(c12,:),'LineWidth',qw)
%% 

%% west of AB
arrow([298.9,-40],[301.6,-40],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
...
arrow([298.9,-48],[301.6,-48],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
arrow([299,-48],[301.5,-48],20,'BaseAngle',90,'Color',Color(c12,:),'LineWidth',qw)
%% 

%% east of AB
arrow([333.9,-40],[336.6,-40],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
...
arrow([333.9,-48],[336.6,-48],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
arrow([334,-48],[336.5,-48],20,'BaseAngle',90,'Color',Color(c12,:),'LineWidth',qw)
%% 

%% east of east of AB
arrow([343.9,-40],[346.6,-40],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
...
arrow([343.9,-48],[346.6,-48],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
arrow([344,-48],[346.5,-48],20,'BaseAngle',90,'Color',Color(c12,:),'LineWidth',qw)
%% 

%% top of east of AB
arrow([337.33,-34.9],[337.33,-37.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
...
arrow([342,-34.9],[342,-37.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
arrow([342,-35],[342,-37.5],20,'BaseAngle',90,'Color',Color(c12,:),'LineWidth',qw)
%% 

%% bottom of east of AB
arrow([337.33,-50.9],[337.33,-53.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
...
arrow([342,-50.9],[342,-53.6],24,'BaseAngle',90,'Color','k','LineWidth',qw+2)
