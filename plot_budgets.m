...
% acc_plots
% hold off
% print('BUDGET_PLOTS/MITgcm_SurfTFLUX','-dpng')
% 
% figure;
% set(gcf, 'Position', [1, 1, 1600, 900])
...
% acc_plots
% hold off
% print('BUDGET_PLOTS/MITgcm_SurfCFLUX','-dpng')
% 
...
% acc_tri_plots_s3
% hold off
% print('BUDGET_PLOTS/THETAEB','-dpng')
% 
% [YC3w,RC3w] = ndgrid(YC3w,RC3);
% [YC6w,RC6w] = ndgrid(YC6w,RC6);
% [YC12w,RC12w] = ndgrid(YC12w,RC12);
...
% acc_tri_plots_s4
% hold off
% print('BUDGET_PLOTS/THETAWB','-dpng')
% 
% [XC3s,RC3s] = ndgrid(XC3s,RC3);
% [XC6s,RC6s] = ndgrid(XC6s,RC6);
% [XC12s,RC12s] = ndgrid(XC12s,RC12);
...
% acc_tri_plots_s3
% hold off
% print('BUDGET_PLOTS/THETASB','-dpng')
% 
% [XC3n,RC3n] = ndgrid(XC3n,RC3);
% [XC6n,RC6n] = ndgrid(XC6n,RC6);
% [XC12n,RC12n] = ndgrid(XC12n,RC12);
...
% acc_tri_plots_s3
% hold off
% print('BUDGET_PLOTS/THETANB','-dpng')
% clear THETA*
% 
% close all
% %%
...
acc_plots
hold off
print('BUDGET_PLOTS/MITgcm_TEMP9m','-dpng')
...
acc_plots
hold off
print('BUDGET_PLOTS/MITgcm_TEMP100m','-dpng')
...
acc_plots
hold off
print('BUDGET_PLOTS/MITgcm_DIC9m','-dpng')
...
acc_plots
hold off
print('BUDGET_PLOTS/MITgcm_DIC100m','-dpng')
%%
