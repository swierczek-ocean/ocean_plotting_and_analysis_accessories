...
WVEL100_62_JFM_avg = mean(WVEL100_Series62(:,:,62:62),3);
WVEL100_62_JFM_std = std(WVEL100_Series62(:,:,62:62),0,3);
WVEL190_62_JFM_avg = mean(WVEL190_Series62(:,:,62:62),3);
WVEL190_62_JFM_std = std(WVEL190_Series62(:,:,62:62),0,3);
WVEL290_62_JFM_avg = mean(WVEL290_Series62(:,:,62:62),3);
WVEL290_62_JFM_std = std(WVEL290_Series62(:,:,62:62),0,3);
TFLUX_62_JFM_avg = mean(TFLUX_Series62(:,:,2:4),3);
SFLUX_62_JFM_avg = mean(SFLUX_Series62(:,:,2:4),3);
ETAN_62_JFM_avg = mean(ETAN_Series62(:,:,62:62),3);
ETAN_62_JFM_std = std(ETAN_Series62(:,:,62:62),0,3);
CFLUX_62_JFM_avg = mean(CFLUX_Series62(:,:,2:4),3);
OFLUX_62_JFM_avg = mean(OFLUX_Series62(:,:,2:4),3);
MLD_62_JFM_avg = mean(MLD_Series62(:,:,62:62),3);
MLD_62_JFM_std = std(MLD_Series62(:,:,62:62),0,3);
...
WVEL100_62_JD_avg = mean(WVEL100_Series62(:,:,62:395),3);
WVEL100_62_JD_std = std(WVEL100_Series62(:,:,62:395),0,3);
WVEL190_62_JD_avg = mean(WVEL190_Series62(:,:,62:395),3);
WVEL190_62_JD_std = std(WVEL190_Series62(:,:,62:395),0,3);
WVEL290_62_JD_avg = mean(WVEL290_Series62(:,:,62:395),3);
WVEL290_62_JD_std = std(WVEL290_Series62(:,:,62:395),0,3);
TFLUX_62_JD_avg = mean(TFLUX_Series62(:,:,2:13),3);
SFLUX_62_JD_avg = mean(SFLUX_Series62(:,:,2:13),3);
ETAN_62_JD_avg = mean(ETAN_Series62(:,:,62:395),3);
ETAN_62_JD_std = std(ETAN_Series62(:,:,62:395),0,3);
CFLUX_62_JD_avg = mean(CFLUX_Series62(:,:,2:13),3);
OFLUX_62_JD_avg = mean(OFLUX_Series62(:,:,2:13),3);
MLD_62_JD_avg = mean(MLD_Series62(:,:,62:395),3);
MLD_62_JD_std = std(MLD_Series62(:,:,62:395),0,3);
