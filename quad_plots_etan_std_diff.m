...
acc_quad_plots_v8
hold off
print('ETAN_STD_05JJA_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_STD_06JAS_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_STD_08JASOND_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_STD_07JJASON_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_STD_01DJF_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_STD_02JFM_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_STD_03DJFMAM_DIFF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_STD_04JFMAMJ_DIFF','-dpng')
close all
%% END ETAN
