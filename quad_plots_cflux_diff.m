...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_05JJA_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_06JAS_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_08JASOND_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_07JJASON_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_01DJF_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_02JFM_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_03DJFMAM_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_04JFMAMJ_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_09DN_DIFF','-dpng')
close all
%% END CFLUX
...
acc_quad_plots_v8
hold off
print('CFLUX_AVG_10JD_DIFF','-dpng')
close all
%% END CFLUX
