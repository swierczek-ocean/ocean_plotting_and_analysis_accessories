...
Obs_130_temp = [time,lat,lon+360,theta,salt];
Obs_130_temp = sortrows(Obs_130_temp,1);

start_date = 20161130;

start = find(Obs_130_temp(:,1)>start_date,1);

Obs_130_temp = Obs_130_temp(start:end,:);
...
for ii=1:396
    ...
    Obs_130(ii,:) = mean(Obs_130_temp(Obs_130_temp(:,1)==date_n,:),1);
    date = date+1;
end

clearvars -except Obs_130
