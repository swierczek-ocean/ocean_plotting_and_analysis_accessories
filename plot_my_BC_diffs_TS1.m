...
for ii=1:12
    ...
    title(['1/12 ',names(ii,:),' 2017 71W theta [deg C]'],...
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['R&G - 1/12 ',names(ii,:),' 2017 71W theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['WOA - 1/12 ',names(ii,:),' 2017 71W theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECCO - 1/12 ',names(ii,:),' 2017 71W theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['SODA - 1/12 ',names(ii,:),' 2017 71W theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECDA - 1/12 ',names(ii,:),' 2017 71W theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    ...
    print('-r200',['BCplots_2/BCshallow/THETA/THETAEB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(7,ax6,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/BCshallow/THETA/THETAWB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['1/12 ',names(ii,:),' 2017 60S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(1,ax1,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['R&G - 1/12 ',names(ii,:),' 2017 60S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(2,ax2,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['WOA - 1/12 ',names(ii,:),' 2017 60S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(3,ax3,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECCO - 1/12 ',names(ii,:),' 2017 60S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(4,ax4,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['SODA - 1/12 ',names(ii,:),' 2017 60S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(5,ax5,cm1,cm2,ub1,lb1,ub2,lb2)
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECDA - 1/12 ',names(ii,:),' 2017 60S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(6,ax6,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/BCshallow/THETA/THETASB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['1/12 ',names(ii,:),' 2017 30S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(1,ax1,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['R&G - 1/12 ',names(ii,:),' 2017 30S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(2,ax2,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['WOA - 1/12 ',names(ii,:),' 2017 30S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(3,ax3,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECCO - 1/12 ',names(ii,:),' 2017 30S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(4,ax4,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['SODA - 1/12 ',names(ii,:),' 2017 30S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(5,ax5,cm1,cm2,ub1,lb1,ub2,lb2)
    ...
    yticks([-800 -600 -400 -200 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECDA - 1/12 ',names(ii,:),' 2017 30S theta [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(6,ax6,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/BCshallow/THETA/THETANB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
...
for ii=1:12
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/THETA/THETAEB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/THETA/THETAWB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/THETA/THETASB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/THETA/THETANB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
...
for ii=1:12
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['1/12 ',names(ii,:),' 2017 71W salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(1,ax1,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['R&G - 1/12 ',names(ii,:),' 2017 71W salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(2,ax2,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['WOA - 1/12 ',names(ii,:),' 2017 71W salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(3,ax3,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECCO - 1/12 ',names(ii,:),' 2017 71W salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(4,ax4,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['SODA - 1/12 ',names(ii,:),' 2017 71W salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(5,ax5,cm1,cm2,ub1,lb1,ub2,lb2)
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECDA - 1/12 ',names(ii,:),' 2017 71W salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(6,ax6,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/SALT/SALTEB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/SALT/SALTWB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['1/12 ',names(ii,:),' 2017 60S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(1,ax1,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['R&G - 1/12 ',names(ii,:),' 2017 60S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(2,ax2,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['WOA - 1/12 ',names(ii,:),' 2017 60S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(3,ax3,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECCO - 1/12 ',names(ii,:),' 2017 60S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(4,ax4,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['SODA - 1/12 ',names(ii,:),' 2017 60S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(5,ax5,cm1,cm2,ub1,lb1,ub2,lb2)
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECDA - 1/12 ',names(ii,:),' 2017 60S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(6,ax6,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/SALT/SALTSB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['1/12 ',names(ii,:),' 2017 30S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(1,ax1,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['R&G - 1/12 ',names(ii,:),' 2017 30S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(2,ax2,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['WOA - 1/12 ',names(ii,:),' 2017 30S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(3,ax3,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECCO - 1/12 ',names(ii,:),' 2017 30S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    acc_movie
    acc_6plots_diff(4,ax4,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['SODA - 1/12 ',names(ii,:),' 2017 30S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(5,ax5,cm1,cm2,ub1,lb1,ub2,lb2)
    ...
    yticks([-4000 -3000 -2000 -1000 0])
    set(gca,'yticklabel',num2str(abs(get(gca,'ytick').')))
    title(['ECDA - 1/12 ',names(ii,:),' 2017 30S salinity [deg C]'],...
        'FontWeight','Normal','FontSize',16)
    xtickformat('degrees')
    acc_movie
    acc_6plots_diff(6,ax6,cm1,cm2,ub1,lb1,ub2,lb2)
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/SALT/SALTNB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
...
for ii=1:12
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/BCshallow/SALT/BCshallow/SALTEB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/BCshallow/SALT/BCshallow/SALTWB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/BCshallow/SALT/BCshallow/SALTSB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
    ...
    hold off
    set(gcf,'InvertHardCopy','off');
    print('-r200',['BCplots_2/BCshallow/SALT/BCshallow/SALTNB_',num2str(ii,'%02.f'),'_',names(ii,:),'_shallow'],'-dpng')
    close all
