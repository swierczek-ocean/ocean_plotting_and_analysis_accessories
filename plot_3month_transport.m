...
for jj=1:6
    ...
    print('-r200',['paper/WT_',num2str(abs(ylimlo(jj)))],'-dpng')
    close all
end
...
for jj=1:6
    ...
    set(gcf,'InvertHardCopy','off');
    print('-r200',['paper/WDIC_',num2str(abs(ylimlo(jj)))],'-dpng')
    close all
end
...
for jj=1:6
    ...
    set(gcf,'InvertHardCopy','off');
    print('-r200',['paper/WS_',num2str(abs(ylimlo(jj)))],'-dpng')
    close all
end
...
for jj=1:6
    ...
    set(gcf,'InvertHardCopy','off');
    print('-r200',['paper/WDO_',num2str(abs(ylimlo(jj)))],'-dpng')
    close all
end
