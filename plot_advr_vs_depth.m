...
h1 = plot(mean(vert_wvel_3,2)./(1e6),RC3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = plot(mean(vert_wvel_6,2)./(1e6),RC6,'LineWidth',lw,'Color',Color(c6,:));
h3 = plot(mean(vert_wvel_12,2)./(1e6),RC12,'LineWidth',lw,'Color',Color(c12,:));
h7 = plot(std(vert_wvel_3,0,2)./(1e6),RC3,'LineWidth',lw,'Color',Color(c3,:));
h8 = plot(std(vert_wvel_6,0,2)./(1e6),RC6,'LineWidth',lw,'Color',Color(c6,:));
h9 = plot(std(vert_wvel_12,0,2)./(1e6),RC12,'LineWidth',lw,'Color',Color(c12,:));
h7.Color(4) = alpha;
h8.Color(4) = alpha;
h9.Color(4) = alpha;
h10.Color(4) = alpha;
...
figure()
set(gcf, 'Position', [1, 1, 1500, 850])
h1 = plot(mean(vert_heat_adv_3,2)./(1e15),RC3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = plot(mean(vert_heat_adv_6,2)./(1e15),RC6,'LineWidth',lw,'Color',Color(c6,:));
h3 = plot(mean(vert_heat_adv_12,2)./(1e15),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
h7 = plot(std(vert_heat_adv_3,0,2)./(1e15),RC3,'LineWidth',lw,'Color',Color(c3,:));
h8 = plot(std(vert_heat_adv_6,0,2)./(1e15),RC6,'LineWidth',lw,'Color',Color(c6,:));
h9 = plot(std(vert_heat_adv_12,0,2)./(1e15),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
figure()
set(gcf, 'Position', [1, 1, 1500, 850])
h1 = plot(mean(vert_salt_adv_3,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = plot(mean(vert_salt_adv_6,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h3 = plot(mean(vert_salt_adv_12,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
h7 = plot(std(vert_salt_adv_3,0,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
h8 = plot(std(vert_salt_adv_6,0,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h9 = plot(std(vert_salt_adv_12,0,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
xline(0)
ylim([-500 20])
title('mean 2017 vertical salt flux [kg]','FontWeight','Normal','FontSize',18)
legend([h1(1),h2(1),h3(1),h4(1),h5(1),h6(1),h7(1),h8(1),h9(1),h10(1),h11(1),h12(1)],...
    '1/3 mean adv','1/6 mean adv','1/12 mean adv','1/3 mean diff',...
    '1/6 mean diff','1/12 mean diff','1/3 std adv','1/6 std adv',...
    '1/12 std adv','1/3 std diff','1/6 std diff','1/12 std diff',...
...
figure()
set(gcf, 'Position', [1, 1, 1500, 850])
h1 = plot(mean(vert_carbon_adv_3,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = plot(mean(vert_carbon_adv_6,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h3 = plot(mean(vert_carbon_adv_12,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
h7 = plot(std(vert_carbon_adv_3,0,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
h8 = plot(std(vert_carbon_adv_6,0,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h9 = plot(std(vert_carbon_adv_12,0,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
figure()
set(gcf, 'Position', [1, 1, 1500, 850])
h1 = plot(mean(vert_oxygen_adv_3,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = plot(mean(vert_oxygen_adv_6,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h3 = plot(mean(vert_oxygen_adv_12,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
h7 = plot(std(vert_oxygen_adv_3,0,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
h8 = plot(std(vert_oxygen_adv_6,0,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h9 = plot(std(vert_oxygen_adv_12,0,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
figure()
set(gcf, 'Position', [1, 1, 1500, 850])
h1 = plot(mean(vert_nitrate_adv_3,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = plot(mean(vert_nitrate_adv_6,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h3 = plot(mean(vert_nitrate_adv_12,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
...
h7 = plot(std(vert_nitrate_adv_3,0,2),RC3,'LineWidth',lw,'Color',Color(c3,:));
h8 = plot(std(vert_nitrate_adv_6,0,2),RC6,'LineWidth',lw,'Color',Color(c6,:));
h9 = plot(std(vert_nitrate_adv_12,0,2),RC12,'LineWidth',lw,'Color',Color(c12,:));
