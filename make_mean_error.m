...
for ii=1:nn
    for jj=1:mm
        ...
        temp = pco2_socat_misfit12(ii,jj,:);
        temp = mean(temp(isnan(temp)==0));
        if isnan(temp)==0
...
temp = temp_socat3(:,3);
pco2_socat_misfit3 = temp_socat3(isnan(temp)==0,:);
temp = temp_socat6(:,3);
pco2_socat_misfit6 = temp_socat6(isnan(temp)==0,:);
temp = temp_socat12(:,3);
pco2_socat_misfit12 = temp_socat12(isnan(temp)==0,:);

save pco2_misfits pco2_socat_misfit*
...
do_woa_misfit3 = zeros(62,32,12);
do_woa_misfit6 = zeros(62,32,12);
do_woa_misfit12 = zeros(62,32,12);
no3_woa_misfit3 = zeros(62,32,12);
no3_woa_misfit6 = zeros(62,32,12);
no3_woa_misfit12 = zeros(62,32,12);

for ii=1:12
    do_woa_misfit3(:,:,ii) = interp_AB(DO_Series32(:,:,ii),XC3,YC3,lon,lat);
    do_woa_misfit6(:,:,ii) = interp_AB(DO_Series62(:,:,ii),XC6,YC6,lon,lat);
    do_woa_misfit12(:,:,ii) = interp_AB(DO_Series122(:,:,ii),XC12,YC12,lon,lat);
    no3_woa_misfit3(:,:,ii) = interp_AB(NO3_Series32(:,:,ii),XC3,YC3,lon,lat);
    no3_woa_misfit6(:,:,ii) = interp_AB(NO3_Series62(:,:,ii),XC6,YC6,lon,lat);
    no3_woa_misfit12(:,:,ii) = interp_AB(NO3_Series122(:,:,ii),XC12,YC12,lon,lat);
end
...
no3_woa_misfit3 = temp_woa_no3_3(isnan(temp)==0,:);
temp = temp_woa_no3_6(:,3);
no3_woa_misfit6 = temp_woa_no3_6(isnan(temp)==0,:);
temp = temp_woa_no3_12(:,3);
no3_woa_misfit12 = temp_woa_no3_12(isnan(temp)==0,:);

temp = temp_woa_do_3(:,3);
do_woa_misfit3 = temp_woa_do_3(isnan(temp)==0,:);
temp = temp_woa_do_6(:,3);
do_woa_misfit6 = temp_woa_do_6(isnan(temp)==0,:);
temp = temp_woa_do_12(:,3);
do_woa_misfit12 = temp_woa_do_12(isnan(temp)==0,:);

save woa_misfits *woa_misfit*
