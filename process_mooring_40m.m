...
str3 = '../OOI_Data/deployment0003_GA03FLMA-RIM01-02-CTDMOG041-recovered_inst-ctdmo_ghqr_instrument_recovered_20161030T233001-20180109T120001.nc';
...
Obs_40_temp = [time,lat,lon+360,theta,salt];
Obs_40_temp = sortrows(Obs_40_temp,1);

start_date = 20161130;

start = find(Obs_40_temp(:,1)>start_date,1);

Obs_40_temp = Obs_40_temp(start:end,:);
...
for ii=1:396
    ...
    Obs_40(ii,:) = mean(Obs_40_temp(Obs_40_temp(:,1)==date_n,:),1);
    date = date+1;
end

clearvars -except Obs_40
