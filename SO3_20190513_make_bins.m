...
WVEL100_32_JFM_avg = mean(WVEL100_Series32(:,:,32:122),3);
WVEL100_32_JFM_std = std(WVEL100_Series32(:,:,32:122),0,3);
WVEL190_32_JFM_avg = mean(WVEL190_Series32(:,:,32:122),3);
WVEL190_32_JFM_std = std(WVEL190_Series32(:,:,32:122),0,3);
WVEL290_32_JFM_avg = mean(WVEL290_Series32(:,:,32:122),3);
WVEL290_32_JFM_std = std(WVEL290_Series32(:,:,32:122),0,3);
TFLUX_32_JFM_avg = mean(TFLUX_Series32(:,:,2:4),3);
SFLUX_32_JFM_avg = mean(SFLUX_Series32(:,:,2:4),3);
ETAN_32_JFM_avg = mean(ETAN_Series32(:,:,32:122),3);
ETAN_32_JFM_std = std(ETAN_Series32(:,:,32:122),0,3);
CFLUX_32_JFM_avg = mean(CFLUX_Series32(:,:,2:4),3);
OFLUX_32_JFM_avg = mean(OFLUX_Series32(:,:,2:4),3);
MLD_32_JFM_avg = mean(MLD_Series32(:,:,32:122),3);
MLD_32_JFM_std = std(MLD_Series32(:,:,32:122),0,3);
...
parfor ii=1:m32
    for jj=1:n32
        if (HC(ii,jj,1)==0)
            ...
            THETA_32_DJF_avg(ii,jj) = NaN;
            SALT_32_DJF_avg(ii,jj) = NaN;
            TFLUX_32_DJF_avg(ii,jj) = NaN;
            SFLUX_32_DJF_avg(ii,jj) = NaN;
            ETAN_32_DJF_avg(ii,jj) = NaN;
            ETAN_32_DJF_std(ii,jj) = NaN;
            CFLUX_32_DJF_avg(ii,jj) = NaN;
            OFLUX_32_DJF_avg(ii,jj) = NaN;
            MLD_32_DJF_avg(ii,jj) = NaN;
            MLD_32_DJF_std(ii,jj) = NaN;
            DIC_32_DJF_avg(ii,jj) = NaN;
            ALK_32_DJF_avg(ii,jj) = NaN;
            THETA_32_JFM_avg(ii,jj) = NaN;
            SALT_32_JFM_avg(ii,jj) = NaN;
            AGE_32_JFM_avg(ii,jj) = NaN;
            TFLUX_32_JFM_avg(ii,jj) = NaN;
            SFLUX_32_JFM_avg(ii,jj) = NaN;
            ETAN_32_JFM_avg(ii,jj) = NaN;
            ETAN_32_JFM_std(ii,jj) = NaN;
            CFLUX_32_JFM_avg(ii,jj) = NaN;
            OFLUX_32_JFM_avg(ii,jj) = NaN;
            MLD_32_JFM_avg(ii,jj) = NaN;
            MLD_32_JFM_std(ii,jj) = NaN;
            DIC_32_JFM_avg(ii,jj) = NaN;
            ALK_32_JFM_avg(ii,jj) = NaN;
            THETA_32_DJFMAM_avg(ii,jj) = NaN;
            SALT_32_DJFMAM_avg(ii,jj) = NaN;
            AGE_32_DJFMAM_avg(ii,jj) = NaN;
            TFLUX_32_DJFMAM_avg(ii,jj) = NaN;
            SFLUX_32_DJFMAM_avg(ii,jj) = NaN;
            ETAN_32_DJFMAM_avg(ii,jj) = NaN;
            ETAN_32_DJFMAM_std(ii,jj) = NaN;
            CFLUX_32_DJFMAM_avg(ii,jj) = NaN;
            OFLUX_32_DJFMAM_avg(ii,jj) = NaN;
            MLD_32_DJFMAM_avg(ii,jj) = NaN;
            MLD_32_DJFMAM_std(ii,jj) = NaN;
            DIC_32_DJFMAM_avg(ii,jj) = NaN;
            ALK_32_DJFMAM_avg(ii,jj) = NaN;
            THETA_32_JFMAMJ_avg(ii,jj) = NaN;
            SALT_32_JFMAMJ_avg(ii,jj) = NaN;
            AGE_32_JFMAMJ_avg(ii,jj) = NaN;
            TFLUX_32_JFMAMJ_avg(ii,jj) = NaN;
            SFLUX_32_JFMAMJ_avg(ii,jj) = NaN;
            ETAN_32_JFMAMJ_avg(ii,jj) = NaN;
            ETAN_32_JFMAMJ_std(ii,jj) = NaN;
            CFLUX_32_JFMAMJ_avg(ii,jj) = NaN;
            OFLUX_32_JFMAMJ_avg(ii,jj) = NaN;
            MLD_32_JFMAMJ_avg(ii,jj) = NaN;
            MLD_32_JFMAMJ_std(ii,jj) = NaN;
            DIC_32_JFMAMJ_avg(ii,jj) = NaN;
            ALK_32_JFMAMJ_avg(ii,jj) = NaN;
            THETA_32_DN_avg(ii,jj) = NaN;
            SALT_32_DN_avg(ii,jj) = NaN;
            AGE_32_DN_avg(ii,jj) = NaN;
            TFLUX_32_DN_avg(ii,jj) = NaN;
            SFLUX_32_DN_avg(ii,jj) = NaN;
            ETAN_32_DN_avg(ii,jj) = NaN;
            ETAN_32_DN_std(ii,jj) = NaN;
            CFLUX_32_DN_avg(ii,jj) = NaN;
            OFLUX_32_DN_avg(ii,jj) = NaN;
            MLD_32_DN_avg(ii,jj) = NaN;
            MLD_32_DN_std(ii,jj) = NaN;
            DIC_32_DN_avg(ii,jj) = NaN;
            ALK_32_DN_avg(ii,jj) = NaN;
            THETA_32_JD_avg(ii,jj) = NaN;
            SALT_32_JD_avg(ii,jj) = NaN;
            AGE_32_JD_avg(ii,jj) = NaN;
            TFLUX_32_JD_avg(ii,jj) = NaN;
            SFLUX_32_JD_avg(ii,jj) = NaN;
            ETAN_32_JD_avg(ii,jj) = NaN;
            ETAN_32_JD_std(ii,jj) = NaN;
            CFLUX_32_JD_avg(ii,jj) = NaN;
            OFLUX_32_JD_avg(ii,jj) = NaN;
            MLD_32_JD_avg(ii,jj) = NaN;
            MLD_32_JD_std(ii,jj) = NaN;
            DIC_32_JD_avg(ii,jj) = NaN;
            ALK_32_JD_avg(ii,jj) = NaN;
        end
        if (HC(ii,jj,13)==0)
            THETA105_32_DJF_avg(ii,jj) = NaN;
            SALT105_32_DJF_avg(ii,jj) = NaN;
            WVEL100_32_DJF_avg(ii,jj) = NaN;
            WVEL100_32_DJF_std(ii,jj) = NaN;
            THETA105_32_JFM_avg(ii,jj) = NaN;
            SALT105_32_JFM_avg(ii,jj) = NaN;
            WVEL100_32_JFM_avg(ii,jj) = NaN;
            WVEL100_32_JFM_std(ii,jj) = NaN;
            THETA105_32_DJFMAM_avg(ii,jj) = NaN;
            SALT105_32_DJFMAM_avg(ii,jj) = NaN;
            WVEL100_32_DJFMAM_avg(ii,jj) = NaN;
            WVEL100_32_DJFMAM_std(ii,jj) = NaN;
            THETA105_32_JFMAMJ_avg(ii,jj) = NaN;
            SALT105_32_JFMAMJ_avg(ii,jj) = NaN;
            WVEL100_32_JFMAMJ_avg(ii,jj) = NaN;
            WVEL100_32_JFMAMJ_std(ii,jj) = NaN;
            THETA105_32_DN_avg(ii,jj) = NaN;
            SALT105_32_DN_avg(ii,jj) = NaN;
            WVEL100_32_DN_avg(ii,jj) = NaN;
            WVEL100_32_DN_std(ii,jj) = NaN;
            THETA105_32_JD_avg(ii,jj) = NaN;
            SALT105_32_JD_avg(ii,jj) = NaN;
            WVEL100_32_JD_avg(ii,jj) = NaN;
            WVEL100_32_JD_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,20)==0)
            THETA200_32_DJF_avg(ii,jj) = NaN;
            SALT200_32_DJF_avg(ii,jj) = NaN;
            AGE200_32_DJF_avg(ii,jj) = NaN;
            WVEL190_32_DJF_avg(ii,jj) = NaN;
            WVEL190_32_DJF_std(ii,jj) = NaN;
            THETA200_32_JFM_avg(ii,jj) = NaN;
            SALT200_32_JFM_avg(ii,jj) = NaN;
            AGE200_32_JFM_avg(ii,jj) = NaN;
            WVEL190_32_JFM_avg(ii,jj) = NaN;
            WVEL190_32_JFM_std(ii,jj) = NaN;
            THETA200_32_DJFMAM_avg(ii,jj) = NaN;
            SALT200_32_DJFMAM_avg(ii,jj) = NaN;
            AGE200_32_DJFMAM_avg(ii,jj) = NaN;
            WVEL190_32_DJFMAM_avg(ii,jj) = NaN;
            WVEL190_32_DJFMAM_std(ii,jj) = NaN;
            THETA200_32_JFMAMJ_avg(ii,jj) = NaN;
            SALT200_32_JFMAMJ_avg(ii,jj) = NaN;
            AGE200_32_JFMAMJ_avg(ii,jj) = NaN;
            WVEL190_32_JFMAMJ_avg(ii,jj) = NaN;
            WVEL190_32_JFMAMJ_std(ii,jj) = NaN;
            THETA200_32_DN_avg(ii,jj) = NaN;
            SALT200_32_DN_avg(ii,jj) = NaN;
            AGE200_32_DN_avg(ii,jj) = NaN;
            WVEL190_32_DN_avg(ii,jj) = NaN;
            WVEL190_32_DN_std(ii,jj) = NaN;
            THETA200_32_JD_avg(ii,jj) = NaN;
            SALT200_32_JD_avg(ii,jj) = NaN;
            AGE200_32_JD_avg(ii,jj) = NaN;
            WVEL190_32_JD_avg(ii,jj) = NaN;
            WVEL190_32_JD_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,25)==0)
            THETA300_32_DJF_avg(ii,jj) = NaN;
            SALT300_32_DJF_avg(ii,jj) = NaN;
            WVEL290_32_DJF_avg(ii,jj) = NaN;
            WVEL290_32_DJF_std(ii,jj) = NaN;
            THETA300_32_JFM_avg(ii,jj) = NaN;
            SALT300_32_JFM_avg(ii,jj) = NaN;
            WVEL290_32_JFM_avg(ii,jj) = NaN;
            WVEL290_32_JFM_std(ii,jj) = NaN;
            THETA300_32_DJFMAM_avg(ii,jj) = NaN;
            SALT300_32_DJFMAM_avg(ii,jj) = NaN;
            WVEL290_32_DJFMAM_avg(ii,jj) = NaN;
            WVEL290_32_DJFMAM_std(ii,jj) = NaN;
            THETA300_32_JFMAMJ_avg(ii,jj) = NaN;
            SALT300_32_JFMAMJ_avg(ii,jj) = NaN;
            WVEL290_32_JFMAMJ_avg(ii,jj) = NaN;
            WVEL290_32_JFMAMJ_std(ii,jj) = NaN;
            THETA300_32_DN_avg(ii,jj) = NaN;
            SALT300_32_DN_avg(ii,jj) = NaN;
            WVEL290_32_DN_avg(ii,jj) = NaN;
            WVEL290_32_DN_std(ii,jj) = NaN;
            THETA300_32_JD_avg(ii,jj) = NaN;
            SALT300_32_JD_avg(ii,jj) = NaN;
            WVEL290_32_JD_avg(ii,jj) = NaN;
            WVEL290_32_JD_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,30)==0)
            AGE500_32_DJF_avg(ii,jj) = NaN;
            AGE500_32_JFM_avg(ii,jj) = NaN;
            AGE500_32_DJFMAM_avg(ii,jj) = NaN;
            AGE500_32_JFMAMJ_avg(ii,jj) = NaN;
            AGE500_32_DN_avg(ii,jj) = NaN;
            AGE500_32_JD_avg(ii,jj) = NaN;
        end
        if (HC(ii,jj,36)==0)
            AGE1000_32_DJF_avg(ii,jj) = NaN;
            AGE1000_32_JFM_avg(ii,jj) = NaN;
            AGE1000_32_DJFMAM_avg(ii,jj) = NaN;
            AGE1000_32_JFMAMJ_avg(ii,jj) = NaN;
            AGE1000_32_DN_avg(ii,jj) = NaN;
            AGE1000_32_JD_avg(ii,jj) = NaN;
        end
        if (HC(ii,jj,42)==0)
            AGE2000_32_DJF_avg(ii,jj) = NaN;
            AGE2000_32_JFM_avg(ii,jj) = NaN;
            AGE2000_32_DJFMAM_avg(ii,jj) = NaN;
            AGE2000_32_JFMAMJ_avg(ii,jj) = NaN;
            AGE2000_32_DN_avg(ii,jj) = NaN;
            AGE2000_32_JD_avg(ii,jj) = NaN;
        end
    end
end

save ETAN_MLD_3 ETAN_Series32 MLD_Series32 
