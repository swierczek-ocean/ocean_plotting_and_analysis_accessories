...
acc_quad_plots_v8
hold off
print('ETAN_AVG_05JJA_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_06JAS_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_07JJASON_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_08JASOND_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_09DN_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_10JD_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_01DJF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_02JFM_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_04JFMAMJ_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_03DJFMAM_outside','-dpng')
close all
%% END ETAN
