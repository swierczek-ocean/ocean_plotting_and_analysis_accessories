...
acc_quad_plots_v4
hold off
print('ETAN_STD_JJA_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_JAS_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_JJASON_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_JASOND_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_DN_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_JD_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_DJF_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_JFM_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_JFMAMJ_outside','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v4
hold off
print('ETAN_STD_DJFMAM_outside','-dpng')
close all
%% END ETAN
