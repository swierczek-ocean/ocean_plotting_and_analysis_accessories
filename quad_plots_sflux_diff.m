...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_05JJA_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_06JAS_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_08JASOND_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_07JJASON_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_01DJF_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_02JFM_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_03DJFMAM_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_04JFMAMJ_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_09DN_DIFF','-dpng')
close all
%% END SFLUX
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','SFLUX_AVG_10JD_DIFF','-dpng')
close all
%% END SFLUX
