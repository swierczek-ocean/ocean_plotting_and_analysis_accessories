...
acc_quad_plots_v8
hold off
print('DIC_AVG_JASOND_DIFF','-dpng')
close all
%% END DIC
...
acc_quad_plots_v8
hold off
print('DIC_AVG_JJASON_DIFF','-dpng')
close all
%% END DIC
...
acc_quad_plots_v8
hold off
print('DIC_AVG_DJFMAM_DIFF','-dpng')
close all
%% END DIC
...
acc_quad_plots_v8
hold off
print('DIC_AVG_JFMAMJ_DIFF','-dpng')
close all
%% END DIC
