...
array_a = zeros(391388,8);
array_b = zeros(393780,8);
...
QC = (ps_qc_e-ps_qc_r)+(st_qc_e-st_qc_r)+(p_qc_e-p_qc_r);
...
array_a(1:L1,:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L1+1):(L1+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L2+1):(L2+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L3+1):(L3+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L4+1):(L4+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L5+1):(L5+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L6+1):(L6+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L7+1):(L7+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L8+1):(L8+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L9+1):(L9+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L10+1):(L10+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_a((L11+1):(L11+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b(1:L1,:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L1+1):(L1+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L2+1):(L2+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L3+1):(L3+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L4+1):(L4+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L5+1):(L5+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L6+1):(L6+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L7+1):(L7+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L8+1):(L8+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L9+1):(L9+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L10+1):(L10+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
...
array_b((L11+1):(L11+len2),:) = [time,lat,lon,temp,salt,pres,dens,depth];
%% 
