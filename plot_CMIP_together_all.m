...
ax1 = subplot(1,2,1);
barh(Yh,Xh,'FaceColor',Color(58,:),'LineWidth',1.3)
hold on
...
acc_movie_w
acc_2plots(2)
xlabel('carbon [g/m^2/yr]','FontSize',18)
