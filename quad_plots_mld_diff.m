...
acc_quad_plots_v8
hold off
print('MLD_AVG_JASOND_DIFF','-dpng')
close all
%% END MLD
...
acc_quad_plots_v8
hold off
print('MLD_AVG_JJASON_DIFF','-dpng')
close all
%% END MLD
...
acc_quad_plots_v8
hold off
print('MLD_AVG_DJFMAM_DIFF','-dpng')
close all
%% END MLD
...
acc_quad_plots_v8
hold off
print('MLD_AVG_JFMAMJ_DIFF','-dpng')
close all
%% END MLD
