...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_05JJA','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_06JAS','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_07JJASON','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_08JASOND','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_09DN','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_10JD','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_01DJF','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_02JFM','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_04JFMAMJ','-dpng')
close all
%% END ETAN
...
acc_quad_plots_v8
hold off
print('ETAN_AVG_AVISO_03DJFMAM','-dpng')
close all
%% END ETAN
