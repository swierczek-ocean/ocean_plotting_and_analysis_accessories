...
contour(XC3,YC3,stf3,'Color','w','LineWidth',lw)
...
contour(XC6,YC6,stf6,'Color','w','LineWidth',lw)
...
contour(XC12,YC12,stf12,'Color','w','LineWidth',lw)
...
print('-r300','sst_with_fronts_2','-dpng')
close all
