...
parfor ii=1:756
    for jj=1:512
        if (HC(ii,jj,1)==0)
            THETA_Series_vert_122(ii,jj,:) = NaN;
            THETA_Series_vert_t122(ii,jj,:) = NaN;
            THETA_Series_vert100_t122(ii,jj,:) = NaN;
            DIC_Series_vert_122(ii,jj,:) = NaN;
            DIC_Series_vert_t122(ii,jj,:) = NaN;
            DIC_Series_vert100_t122(ii,jj,:) = NaN;
            O2_Series_vert_122(ii,jj,:) = NaN;
            O2_Series_vert_t122(ii,jj,:) = NaN;
            O2_Series_vert100_t122(ii,jj,:) = NaN;
            NO3_Series_vert_122(ii,jj,:) = NaN;
            NO3_Series_vert_t122(ii,jj,:) = NaN;
            NO3_Series_vert100_t122(ii,jj,:) = NaN;
        end
    end
end
...
ETAN_122_DJF_slice_avg = mean(ETAN_Series_slice_122(:,1:91),2);
MLD_122_DJF_slice_avg = mean(MLD_Series_slice_122(:,1:91),2);
PCO2_122_DJF_slice_avg = mean(PCO2_Series_slice_122(:,1:91),2);
TFLUX_122_DJF_slice_avg = mean(TFLUX_Series_slice_122(:,1:91),2);
SFLUX_122_DJF_slice_avg = mean(SFLUX_Series_slice_122(:,1:91),2);
CFLUX_122_DJF_slice_avg = mean(CFLUX_Series_slice_122(:,1:91),2);
OFLUX_122_DJF_slice_avg = mean(OFLUX_Series_slice_122(:,1:91),2);
...
ETAN_122_JFM_slice_avg = mean(ETAN_Series_slice_122(:,32:122),2);
MLD_122_JFM_slice_avg = mean(MLD_Series_slice_122(:,32:122),2);
PCO2_122_JFM_slice_avg = mean(PCO2_Series_slice_122(:,32:122),2);
TFLUX_122_JFM_slice_avg = mean(TFLUX_Series_slice_122(:,32:122),2);
SFLUX_122_JFM_slice_avg = mean(SFLUX_Series_slice_122(:,32:122),2);
CFLUX_122_JFM_slice_avg = mean(CFLUX_Series_slice_122(:,32:122),2);
OFLUX_122_JFM_slice_avg = mean(OFLUX_Series_slice_122(:,32:122),2);
...
ETAN_122_DJFMAM_slice_avg = mean(ETAN_Series_slice_122(:,1:182),2);
MLD_122_DJFMAM_slice_avg = mean(MLD_Series_slice_122(:,1:182),2);
PCO2_122_DJFMAM_slice_avg = mean(PCO2_Series_slice_122(:,1:182),2);
TFLUX_122_DJFMAM_slice_avg = mean(TFLUX_Series_slice_122(:,1:182),2);
SFLUX_122_DJFMAM_slice_avg = mean(SFLUX_Series_slice_122(:,1:182),2);
CFLUX_122_DJFMAM_slice_avg = mean(CFLUX_Series_slice_122(:,1:182),2);
OFLUX_122_DJFMAM_slice_avg = mean(OFLUX_Series_slice_122(:,1:182),2);
...
ETAN_122_JFMAMJ_slice_avg = mean(ETAN_Series_slice_122(:,32:213),2);
MLD_122_JFMAMJ_slice_avg = mean(MLD_Series_slice_122(:,32:213),2);
PCO2_122_JFMAMJ_slice_avg = mean(PCO2_Series_slice_122(:,32:213),2);
TFLUX_122_JFMAMJ_slice_avg = mean(TFLUX_Series_slice_122(:,32:213),2);
SFLUX_122_JFMAMJ_slice_avg = mean(SFLUX_Series_slice_122(:,32:213),2);
CFLUX_122_JFMAMJ_slice_avg = mean(CFLUX_Series_slice_122(:,32:213),2);
OFLUX_122_JFMAMJ_slice_avg = mean(OFLUX_Series_slice_122(:,32:213),2);
...
ETAN_122_DN_slice_avg = mean(ETAN_Series_slice_122(:,1:364),2);
MLD_122_DN_slice_avg = mean(MLD_Series_slice_122(:,1:364),2);
PCO2_122_DN_slice_avg = mean(PCO2_Series_slice_122(:,1:364),2);
TFLUX_122_DN_slice_avg = mean(TFLUX_Series_slice_122(:,1:364),2);
SFLUX_122_DN_slice_avg = mean(SFLUX_Series_slice_122(:,1:364),2);
CFLUX_122_DN_slice_avg = mean(CFLUX_Series_slice_122(:,1:364),2);
OFLUX_122_DN_slice_avg = mean(OFLUX_Series_slice_122(:,1:364),2);
...
ETAN_122_JD_slice_avg = mean(ETAN_Series_slice_122(:,32:395),2);
MLD_122_JD_slice_avg = mean(MLD_Series_slice_122(:,32:395),2);
PCO2_122_JD_slice_avg = mean(PCO2_Series_slice_122(:,32:395),2);
TFLUX_122_JD_slice_avg = mean(TFLUX_Series_slice_122(:,32:395),2);
SFLUX_122_JD_slice_avg = mean(SFLUX_Series_slice_122(:,32:395),2);
CFLUX_122_JD_slice_avg = mean(CFLUX_Series_slice_122(:,32:395),2);
OFLUX_122_JD_slice_avg = mean(OFLUX_Series_slice_122(:,32:395),2);
...
parfor ii=1:m122
    for jj=1:n122
        if (HC(slice_index,ii,jj)==0)
            THETA_Series_slice_122(ii,jj,:) = NaN;
            SALT_Series_slice_122(ii,jj,:) = NaN;
            WVEL_Series_slice_122(ii,jj,:) = NaN;
            UVEL_Series_slice_122(ii,jj,:) = NaN;
            VVEL_Series_slice_122(ii,jj,:) = NaN;
            DIC_Series_slice_122(ii,jj,:) = NaN;
            ALK_Series_slice_122(ii,jj,:) = NaN;
            O2_Series_slice_122(ii,jj,:) = NaN;
            NO3_Series_slice_122(ii,jj,:) = NaN;
            
            THETA_122_DJF_slice_avg(ii,jj) = NaN;
            SALT_122_DJF_slice_avg(ii,jj) = NaN;
            DIC_122_DJF_slice_avg(ii,jj) = NaN;
            ALK_122_DJF_slice_avg(ii,jj) = NaN;
            WVEL_122_DJF_slice_avg(ii,jj) = NaN;
            VVEL_122_DJF_slice_avg(ii,jj) = NaN;
            UVEL_122_DJF_slice_avg(ii,jj) = NaN;
            O2_122_DJF_slice_avg(ii,jj) = NaN;
            NO3_122_DJF_slice_avg(ii,jj) = NaN;
            
            THETA_122_JFM_slice_avg(ii,jj) = NaN;
            SALT_122_JFM_slice_avg(ii,jj) = NaN;
            DIC_122_JFM_slice_avg(ii,jj) = NaN;
            ALK_122_JFM_slice_avg(ii,jj) = NaN;
            WVEL_122_JFM_slice_avg(ii,jj) = NaN;
            VVEL_122_JFM_slice_avg(ii,jj) = NaN;
            UVEL_122_JFM_slice_avg(ii,jj) = NaN;
            O2_122_JFM_slice_avg(ii,jj) = NaN;
            NO3_122_JFM_slice_avg(ii,jj) = NaN;
            
            THETA_122_DJFMAM_slice_avg(ii,jj) = NaN;
            SALT_122_DJFMAM_slice_avg(ii,jj) = NaN;
            DIC_122_DJFMAM_slice_avg(ii,jj) = NaN;
            ALK_122_DJFMAM_slice_avg(ii,jj) = NaN;
            WVEL_122_DJFMAM_slice_avg(ii,jj) = NaN;
            VVEL_122_DJFMAM_slice_avg(ii,jj) = NaN;
            UVEL_122_DJFMAM_slice_avg(ii,jj) = NaN;
            O2_122_DJFMAM_slice_avg(ii,jj) = NaN;
            NO3_122_DJFMAM_slice_avg(ii,jj) = NaN;
            
            THETA_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            SALT_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            DIC_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            ALK_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            WVEL_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            VVEL_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            UVEL_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            O2_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            NO3_122_JFMAMJ_slice_avg(ii,jj) = NaN;
            
            THETA_122_DN_slice_avg(ii,jj) = NaN;
            SALT_122_DN_slice_avg(ii,jj) = NaN;
            DIC_122_DN_slice_avg(ii,jj) = NaN;
            ALK_122_DN_slice_avg(ii,jj) = NaN;
            WVEL_122_DN_slice_avg(ii,jj) = NaN;
            VVEL_122_DN_slice_avg(ii,jj) = NaN;
            UVEL_122_DN_slice_avg(ii,jj) = NaN;
            O2_122_DN_slice_avg(ii,jj) = NaN;
            NO3_122_DN_slice_avg(ii,jj) = NaN;
            
            THETA_122_JD_slice_avg(ii,jj) = NaN;
            SALT_122_JD_slice_avg(ii,jj) = NaN;
            DIC_122_JD_slice_avg(ii,jj) = NaN;
            ALK_122_JD_slice_avg(ii,jj) = NaN;
            WVEL_122_JD_slice_avg(ii,jj) = NaN;
            VVEL_122_JD_slice_avg(ii,jj) = NaN;
            UVEL_122_JD_slice_avg(ii,jj) = NaN;
            O2_122_JD_slice_avg(ii,jj) = NaN;
            NO3_122_JD_slice_avg(ii,jj) = NaN;
        end
    end
end
