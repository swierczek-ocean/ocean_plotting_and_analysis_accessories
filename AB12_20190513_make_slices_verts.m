...
THETA_Series_slice_122 = zeros(512,52,395);
SALT_Series_slice_122 = zeros(512,52,395);
WVEL_Series_slice_122 = zeros(512,52,395);
UVEL_Series_slice_122 = zeros(512,52,395);
VVEL_Series_slice_122 = zeros(512,52,395);
DIC_Series_slice_122 = zeros(512,52,395);
ALK_Series_slice_122 = zeros(512,52,395);
O2_Series_slice_122 = zeros(512,52,395);
NO3_Series_slice_122 = zeros(512,52,395);
...
for ii=1:2
    ...
    THETA_Series_vert100_t122(:,:,ii) = sum(temp122state(:,:,1:10,tfield122).*Volume(:,:,1:10),3);
