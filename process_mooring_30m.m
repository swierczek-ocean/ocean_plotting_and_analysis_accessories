...
Obs_30_temp = [time,lat,lon+360,theta,salt];
Obs_30_temp = sortrows(Obs_30_temp,1);

start_date = 20161130;

start = find(Obs_30_temp(:,1)>start_date,1);

Obs_30_temp = Obs_30_temp(start:end,:);
...
for ii=1:396
    ...
    Obs_30(ii,:) = mean(Obs_30_temp(Obs_30_temp(:,1)==date_n,:),1);
    date = date+1;
end

clearvars -except Obs_30
