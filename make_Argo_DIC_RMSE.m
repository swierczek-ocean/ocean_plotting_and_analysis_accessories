...
load ../2020_02_February_analysis/PROFILES/DIC_VIZ_SO_2017_PFL_3
...
prof_DICmod = prof_DICmod(box_ind,:);
prof_DICobs = prof_DICobs(box_ind,:);
...
A = 2357 - sum(isnan(prof_DICdif),1)';

[[4:100]',prof_depth,A,prof_mean]

big_array = [mltime,prof_lon',prof_lat',prof_DICdif];
...
load ../2020_02_February_analysis/PROFILES/DIC_VIZ_SO_2017_PFL_6
...
load ../2020_02_February_analysis/PROFILES/DIC_VIZ_SO_2017_PFL_12
...
save MEAN_ARGO_DIC MEAN* SD* strg 
