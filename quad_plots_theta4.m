...
[lon_metb,lat_metb] = latlon_to_meters(XCS,YCS);
[lon_metm,lat_metm] = latlon_to_meters(XCm,YCm);

figure()
set(gcf, 'Position', [1, 1, 1600, 900])
colormap(cm)
ax1 = subplot(2,2,1);
surf(ax1,lon_metb,lat_metb,THETA_BSOSE_JJA_avg,'EdgeColor','none');
hold on
contour(lon_metm,lat_metm,mask(:,:,1)','Color','k')
caxis([lb ub])
% axis(inside_coords)
% ytickformat('degrees')
...
ax2 = subplot(2,2,2);
surf(ax2,lon_met3,lat_met3,THETA_34_JJA_avg,'EdgeColor','none');
hold on
contour(lon_metm,lat_metm,mask(:,:,1)','Color','k')
caxis([lb ub])
% axis(inside_coords)
...
ax3 = subplot(2,2,3);
surf(ax3,lon_met6,lat_met6,THETA_64_JJA_avg,'EdgeColor','none');
hold on
contour(lon_metm,lat_metm,mask(:,:,1)','Color','k')
caxis([lb ub])
% axis(inside_coords)
...
ax4 = subplot(2,2,4);
surf(ax4,lon_met12,lat_met12,THETA_124_JJA_avg,'EdgeColor','none');
hold on
