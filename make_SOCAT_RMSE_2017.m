...
pco2_socat_misfit3 = zeros(size(pco2_socat_2017));
pco2_socat_misfit6 = zeros(size(pco2_socat_2017));
pco2_socat_misfit12 = zeros(size(pco2_socat_2017));
...
save pco2_rmse_2017 pco2_socat_rmse*
