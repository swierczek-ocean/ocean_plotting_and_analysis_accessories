...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['350m potential temperature 60 day PSD starting on ',startday],...
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_350m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_350m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['500m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_500m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_500m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['750m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_750m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_750m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['1500m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_1500m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_1500m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['250m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_250m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_250m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['180m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_180m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_180m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['130m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_130m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_130m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['90m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_90m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_90m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['60m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_60m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_60m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['40m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_40m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_40m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['30m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_30m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_30m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
dyn_OOI = Proc_GA_OOI_CTD_1000mA_dep3(time_ind_startOA:(time_ind_startOA+NT-1),4);
dyn_3M = MITgcm3_OOI_CTD_1000m(time_ind_startM:(time_ind_startM+NT-1),2);
dyn_6M = MITgcm6_OOI_CTD_1000m(time_ind_startM:(time_ind_startM+NT-1),2);
dyn_12M = MITgcm12_OOI_CTD_1000m(time_ind_startM:(time_ind_startM+NT-1),2);
...
xlabel('cpd')
ylabel('[degC^2/cpd]')
title(['1000m potential temperature 60 day PSD starting on ',startday],...
    'Interpreter','none','FontWeight','Normal')
set(gca,'fontsize',18)
grid on;
acc_plots
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_1000m_A_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
...
dyn_OOI = Proc_GA_OOI_CTD_1000mB_dep3(time_ind_startOB:(time_ind_startOB+NT-1),4);
dyn_3M = MITgcm3_OOI_CTD_1000m(time_ind_startM:(time_ind_startM+NT-1),4);
dyn_6M = MITgcm6_OOI_CTD_1000m(time_ind_startM:(time_ind_startM+NT-1),4);
dyn_12M = MITgcm12_OOI_CTD_1000m(time_ind_startM:(time_ind_startM+NT-1),4);
...
acc_movie
hold off
print(['PSD_OOI_vs_MITgcm_THETA_1000m_B_',datestr(startnum,'yyyymmdd'),'_20d'],'-dpng')
