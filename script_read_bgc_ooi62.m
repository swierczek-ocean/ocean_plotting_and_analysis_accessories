...
dic_ooia_62 = zeros(53,9491);
dic_ooib_62 = zeros(53,9491);
dic_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',10);
dic_ooia_62(:,counter) = results{1};
counter = 2; 
...
alk_ooia_62 = zeros(53,9491);
alk_ooib_62 = zeros(53,9491);
alk_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',176);
alk_ooia_62(:,counter) = results{1};
counter = 2; 
...
o2_ooia_62 = zeros(53,9491);
o2_ooib_62 = zeros(53,9491);
o2_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',342);
o2_ooia_62(:,counter) = results{1};
counter = 2; 
...
no3_ooia_62 = zeros(53,9491);
no3_ooib_62 = zeros(53,9491);
no3_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',508);
no3_ooia_62(:,counter) = results{1};
counter = 2; 
...
po4_ooia_62 = zeros(53,9491);
po4_ooib_62 = zeros(53,9491);
po4_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',674);
po4_ooia_62(:,counter) = results{1};
counter = 2; 
...
fe_ooia_62 = zeros(53,9491);
fe_ooib_62 = zeros(53,9491);
fe_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',840);
fe_ooia_62(:,counter) = results{1};
counter = 2; 
...
don_ooia_62 = zeros(53,9491);
don_ooib_62 = zeros(53,9491);
don_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',1006);
don_ooia_62(:,counter) = results{1};
counter = 2; 
...
dop_ooia_62 = zeros(53,9491);
dop_ooib_62 = zeros(53,9491);
dop_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',1172);
dop_ooia_62(:,counter) = results{1};
counter = 2; 
...
age_ooia_62 = zeros(53,9491);
age_ooib_62 = zeros(53,9491);
age_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',1338);
age_ooia_62(:,counter) = results{1};
counter = 2; 
...
ph_ooia_62 = zeros(53,9491);
ph_ooib_62 = zeros(53,9491);
ph_ooip_62 = zeros(53,9491);

counter = 1;

fid = fopen('../MITgcm/verification/SO6_20190513/diag_ooi/diag_bgc_ooi.0000000000.txt');
results = textscan(fid, ' %*u %f %*f %*f %*f %*f', 53,'headerlines',1504);
ph_ooia_62(:,counter) = results{1};
counter = 2; 
