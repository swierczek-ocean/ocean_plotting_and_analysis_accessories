...
%         'FontSize',18,'Location','eastoutside')
    ...
    print('-r300',['vert_eddy/whoa/mean_vert_2000_all_heat_',num2str(abs(ylimlo(jj)))],'-dpng')
    close all
...
%     hold off
%     set(gcf,'InvertHardCopy','off');
%     print('-r300',['vert_eddy/whoa/mean_vert_2000_heat_',num2str(abs(ylimlo(jj)))],'-dpng')
%     
%     
%     
%     figure()
...
%     
%     set(gcf,'InvertHardCopy','off');
%     print('-r300',['vert_eddy/whoa/mean_vert_2000_DIC_',num2str(abs(ylimlo(jj)))],'-dpng')
%     close all
end