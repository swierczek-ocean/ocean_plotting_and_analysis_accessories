...
fid = fopen('PHYTO_SM_NBC_2013to2017_monthly_6.bin','w','b');
fwrite(fid,PHYTO_SMN,'single');
fclose(fid);

fid = fopen('PHYTO_SM_SBC_2013to2017_monthly_6.bin','w','b');
fwrite(fid,PHYTO_SMS,'single');
fclose(fid);

fid = fopen('PHYTO_SM_EBC_2013to2017_monthly_6.bin','w','b');
fwrite(fid,PHYTO_SME,'single');
fclose(fid);

fid = fopen('PHYTO_SM_WBC_2013to2017_monthly_6.bin','w','b');
...
fid = fopen('AGE_NBC_2013to2017_monthly_62.bin','w','b');
fwrite(fid,AGEN,'single');
fclose(fid);

fid = fopen('AGE_SBC_2013to2017_monthly_62.bin','w','b');
fwrite(fid,AGES,'single');
fclose(fid);

fid = fopen('AGE_EBC_2013to2017_monthly_62.bin','w','b');
fwrite(fid,AGEE,'single');
fclose(fid);

fid = fopen('AGE_WBC_2013to2017_monthly_62.bin','w','b');
...
fid = fopen('AGE_NBC_2013to2017_monthly_64.bin','w','b');
fwrite(fid,AGEN,'single');
fclose(fid);

fid = fopen('AGE_SBC_2013to2017_monthly_64.bin','w','b');
fwrite(fid,AGES,'single');
fclose(fid);

fid = fopen('AGE_EBC_2013to2017_monthly_64.bin','w','b');
fwrite(fid,AGEE,'single');
fclose(fid);

fid = fopen('AGE_WBC_2013to2017_monthly_64.bin','w','b');
fwrite(fid,AGEW,'single');
fclose(fid);
