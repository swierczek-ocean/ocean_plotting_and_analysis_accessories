...
h11 = plot(odamwt,RFt,'LineWidth',lw,'Color','k');
...
h10 = plot(odawt,RFt,'--','LineWidth',lw,'Color','k');
...
legend([h1(1),h2(1),h3(1),h11(1),h4(1),h5(1),h6(1),h10(1),h7(1),h8(1),h9(1)],...
'1/3 <w*theta>','1/6 <w*theta>','1/12 <w*theta>','ODA <wtheta>',...
'1/3 <w><theta>','1/6 <w><theta>','1/12 <w><theta>','ODA <w><theta>',...
...
print('-r300','vert_eddy/mean_vert_2000_stuff_250','-dpng')
...
set(gcf,'InvertHardCopy','off');
print('-r300','vert_eddy/mean_vert_2000_stuff_500','-dpng')
...
set(gcf,'InvertHardCopy','off');
print('-r300','vert_eddy/mean_vert_2000_stuff_1000','-dpng')
