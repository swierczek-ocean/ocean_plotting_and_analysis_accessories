...
figure()
set(gcf, 'Position', [1, 1, 1600, 900])
h1 = semilogy(six_hours,syr.*lin_cf3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = semilogy(six_hours,syr.*lin_cf12,'LineWidth',lw,'Color',Color(c12,:));
h3 = semilogy(six_hours,syr.*nonlin_cf3,':','LineWidth',lw,'Color',Color(c3,:));
h4 = semilogy(six_hours,syr.*nonlin_cf12,':','LineWidth',lw,'Color',Color(c12,:));
grid on
ax = gca;
ax.GridAlpha = 1;
xticks(dates2)
...
figure()
set(gcf, 'Position', [1, 1, 1600, 900])
h1 = semilogy(six_hours,1000000.*lin_dic3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = semilogy(six_hours,1000000.*lin_dic12,'LineWidth',lw,'Color',Color(c12,:));
h3 = semilogy(six_hours,1000000.*nonlin_dic3,':','LineWidth',lw,'Color',Color(c3,:));
h4 = semilogy(six_hours,1000000.*nonlin_dic12,':','LineWidth',lw,'Color',Color(c12,:));
grid on
ax = gca;
ax.GridAlpha = 1;
xticks(dates2)
...
acc_movie_wh
acc_plots
title('surface DIC response to finite wind perturbation [\mumol C/m^3]','FontWeight','Normal','FontSize',20)
legend([h1(1),h2(1),h3(1),h4(1)],...
    '1/3 linear','1/12 linear','1/3 nonlinear',...
    '1/12 nonlinear','Location','eastoutside','FontSize',16)
hold off
...
figure()
set(gcf, 'Position', [1, 1, 1600, 900])
h1 = semilogy(six_hours,1000000.*lin_do3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = semilogy(six_hours,1000000.*lin_do12,'LineWidth',lw,'Color',Color(c12,:));
h3 = semilogy(six_hours,1000000.*nonlin_do3,':','LineWidth',lw,'Color',Color(c3,:));
h4 = semilogy(six_hours,1000000.*nonlin_do12,':','LineWidth',lw,'Color',Color(c12,:));
grid on
ax = gca;
ax.GridAlpha = 1;
xticks(dates2)
...
acc_movie_wh
acc_plots
title('surface dissolved oxygen response to finite wind perturbation [\mumol O/m^3]','FontWeight','Normal','FontSize',20)
legend([h1(1),h2(1),h3(1),h4(1)],...
    '1/3 linear','1/12 linear','1/3 nonlinear',...
    '1/12 nonlinear','Location','eastoutside','FontSize',16)
hold off
...
figure()
set(gcf, 'Position', [1, 1, 1600, 900])
h1 = semilogy(six_hours,1000000.*lin_no3,'LineWidth',lw,'Color',Color(c3,:));
hold on
h2 = semilogy(six_hours,1000000.*lin_no12,'LineWidth',lw,'Color',Color(c12,:));
h3 = semilogy(six_hours,1000000.*nonlin_no3,':','LineWidth',lw,'Color',Color(c3,:));
h4 = semilogy(six_hours,1000000.*nonlin_no12,':','LineWidth',lw,'Color',Color(c12,:));
grid on
ax = gca;
ax.GridAlpha = 1;
xticks(dates2)
...
acc_movie_wh
acc_plots
title('surface nitrate response to finite wind perturbation [\mumol N/m^3]','FontWeight','Normal','FontSize',20)
legend([h1(1),h2(1),h3(1),h4(1)],...
    '1/3 linear','1/12 linear','1/3 nonlinear',...
    '1/12 nonlinear','Location','eastoutside','FontSize',16)
hold off
