...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_05JJA_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_06JAS_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_08JASOND_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_07JJASON_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_01DJF_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_02JFM_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_03DJFMAM_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_04JFMAMJ_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_09DN_DIFF_outside','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
set(gcf,'InvertHardCopy','off'); print('-r300','ETAN_STD_10JD_DIFF_outside','-dpng')
close all
%% END WVEL
