...
WVEL100_64_JAS_avg = mean(WVEL100_Series64(:,:,32:64),3);
WVEL100_64_JAS_std = std(WVEL100_Series64(:,:,32:64),0,3);
WVEL190_64_JAS_avg = mean(WVEL190_Series64(:,:,32:64),3);
WVEL190_64_JAS_std = std(WVEL190_Series64(:,:,32:64),0,3);
WVEL290_64_JAS_avg = mean(WVEL290_Series64(:,:,32:64),3);
WVEL290_64_JAS_std = std(WVEL290_Series64(:,:,32:64),0,3);
TFLUX_64_JAS_avg = mean(TFLUX_Series64(:,:,2:4),3);
SFLUX_64_JAS_avg = mean(SFLUX_Series64(:,:,2:4),3);
ETAN_64_JAS_avg = mean(ETAN_Series64(:,:,32:64),3);
ETAN_64_JAS_std = std(ETAN_Series64(:,:,32:64),0,3);
CFLUX_64_JAS_avg = mean(CFLUX_Series64(:,:,2:4),3);
OFLUX_64_JAS_avg = mean(OFLUX_Series64(:,:,2:4),3);
MLD_64_JAS_avg = mean(MLD_Series64(:,:,32:64),3);
MLD_64_JAS_std = std(MLD_Series64(:,:,32:64),0,3);
...
parfor ii=1:m64
    for jj=1:n64
        if (HC(ii,jj)==0)
            ...
            MLD_64_JJA_avg(ii,jj) = 99999999;
            MLD_64_JJA_std(ii,jj) = 99999999;
            DIC_64_JJA_avg(ii,jj) = 99999999;
            ...
            ETAN_64_JAS_std(ii,jj) = 99999999;
            CFLUX_64_JAS_avg(ii,jj) = 99999999;
            OFLUX_64_JAS_avg(ii,jj) = 99999999;
            MLD_64_JAS_avg(ii,jj) = 99999999;
            MLD_64_JAS_std(ii,jj) = 99999999;
            DIC_64_JAS_avg(ii,jj) = 99999999;
            ...
            ETAN_64_JJASON_std(ii,jj) = 99999999;
            CFLUX_64_JJASON_avg(ii,jj) = 99999999;
            OFLUX_64_JJASON_avg(ii,jj) = 99999999;
            MLD_64_JJASON_avg(ii,jj) = 99999999;
            MLD_64_JJASON_std(ii,jj) = 99999999;
            DIC_64_JJASON_avg(ii,jj) = 99999999;
            ...
            ETAN_64_JASOND_std(ii,jj) = 99999999;
            CFLUX_64_JASOND_avg(ii,jj) = 99999999;
            OFLUX_64_JASOND_avg(ii,jj) = 99999999;
            MLD_64_JASOND_avg(ii,jj) = 99999999;
            MLD_64_JASOND_std(ii,jj) = 99999999;
