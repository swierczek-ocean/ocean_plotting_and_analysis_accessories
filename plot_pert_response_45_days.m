...
print('-r200','plots/pert_response_45_01_SST','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_02_SSH','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_03_TF','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_04_CF','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_05_DIC','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_06_DO','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_07_NO','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_08_MLD','-dpng')
...
hold off
set(gcf,'InvertHardCopy','off'); 
print('-r200','plots/pert_response_45_09_SSS','-dpng')
