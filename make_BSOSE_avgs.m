...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            THETA_BSOSE_DJF_avg(ii,jj) = NaN;
	        THETA_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            THETA_BSOSE_DN_avg(ii,jj) = NaN;
            THETA_BSOSE_JJA_avg(ii,jj) = NaN;
            THETA_BSOSE_JAS_avg(ii,jj) = NaN;
            THETA_BSOSE_JJASON_avg(ii,jj) = NaN;
            THETA_BSOSE_JASOND_avg(ii,jj) = NaN;
            THETA_BSOSE_JFM_avg(ii,jj) = NaN;
            THETA_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            THETA_BSOSE_JD_avg(ii,jj) = NaN;            
        end
        if (HC(ii,jj,13)==0)
            THETA105_BSOSE_DJF_avg(ii,jj) = NaN;
	        THETA105_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            THETA105_BSOSE_DN_avg(ii,jj) = NaN;
            THETA105_BSOSE_JJA_avg(ii,jj) = NaN;
            THETA105_BSOSE_JAS_avg(ii,jj) = NaN;
            THETA105_BSOSE_JJASON_avg(ii,jj) = NaN;
            THETA105_BSOSE_JASOND_avg(ii,jj) = NaN;
            THETA105_BSOSE_JFM_avg(ii,jj) = NaN;
            THETA105_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            THETA105_BSOSE_JD_avg(ii,jj) = NaN;
        end
        if (HC(ii,jj,20)==0)
            THETA200_BSOSE_DJF_avg(ii,jj) = NaN;
	        THETA200_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            THETA200_BSOSE_DN_avg(ii,jj) = NaN;
            THETA200_BSOSE_JJA_avg(ii,jj) = NaN;
            THETA200_BSOSE_JAS_avg(ii,jj) = NaN;
            THETA200_BSOSE_JJASON_avg(ii,jj) = NaN;
            THETA200_BSOSE_JASOND_avg(ii,jj) = NaN;
            THETA200_BSOSE_JFM_avg(ii,jj) = NaN;
            THETA200_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            THETA200_BSOSE_JD_avg(ii,jj) = NaN;
        end
        if (HC(ii,jj,25)==0)
            THETA300_BSOSE_DJF_avg(ii,jj) = NaN;
	        THETA300_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            THETA300_BSOSE_DN_avg(ii,jj) = NaN;
            THETA300_BSOSE_JJA_avg(ii,jj) = NaN;
            THETA300_BSOSE_JAS_avg(ii,jj) = NaN;
            THETA300_BSOSE_JJASON_avg(ii,jj) = NaN;
            THETA300_BSOSE_JASOND_avg(ii,jj) = NaN;
            THETA300_BSOSE_JFM_avg(ii,jj) = NaN;
            THETA300_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            THETA300_BSOSE_JD_avg(ii,jj) = NaN;
        end
        if (HC(ii,jj,30)==0)
            THETA500_BSOSE_DJF_avg(ii,jj) = NaN;
	        THETA500_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            THETA500_BSOSE_DN_avg(ii,jj) = NaN;
            THETA500_BSOSE_JJA_avg(ii,jj) = NaN;
            THETA500_BSOSE_JAS_avg(ii,jj) = NaN;
            THETA500_BSOSE_JJASON_avg(ii,jj) = NaN;
            THETA500_BSOSE_JASOND_avg(ii,jj) = NaN;
            THETA500_BSOSE_JFM_avg(ii,jj) = NaN;
            THETA500_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            THETA500_BSOSE_JD_avg(ii,jj) = NaN;            
        end
        if (HC(ii,jj,36)==0)
            THETA1000_BSOSE_DJF_avg(ii,jj) = NaN;
	        THETA1000_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            THETA1000_BSOSE_DN_avg(ii,jj) = NaN;
            THETA1000_BSOSE_JJA_avg(ii,jj) = NaN;
            THETA1000_BSOSE_JAS_avg(ii,jj) = NaN;
            THETA1000_BSOSE_JJASON_avg(ii,jj) = NaN;
            THETA1000_BSOSE_JASOND_avg(ii,jj) = NaN;
            THETA1000_BSOSE_JFM_avg(ii,jj) = NaN;
            THETA1000_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            THETA1000_BSOSE_JD_avg(ii,jj) = NaN;     
        end
        if (HC(ii,jj,42)==0)
            THETA2000_BSOSE_DJF_avg(ii,jj) = NaN;
	        THETA2000_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            THETA2000_BSOSE_DN_avg(ii,jj) = NaN;
            THETA2000_BSOSE_JJA_avg(ii,jj) = NaN;
            THETA2000_BSOSE_JAS_avg(ii,jj) = NaN;
            THETA2000_BSOSE_JJASON_avg(ii,jj) = NaN;
            THETA2000_BSOSE_JASOND_avg(ii,jj) = NaN;
            THETA2000_BSOSE_JFM_avg(ii,jj) = NaN;
            THETA2000_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            THETA2000_BSOSE_JD_avg(ii,jj) = NaN;            
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            ETAN_BSOSE_JJA_avg(ii,jj) = NaN;
            ETAN_BSOSE_JJASON_avg(ii,jj) = NaN;
            ETAN_BSOSE_DN_avg(ii,jj) = NaN;
            ETAN_BSOSE_DJF_avg(ii,jj) = NaN;
            ETAN_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            ETAN_BSOSE_JAS_avg(ii,jj) = NaN;
            ETAN_BSOSE_JASOND_avg(ii,jj) = NaN;
            ETAN_BSOSE_JD_avg(ii,jj) = NaN;
            ETAN_BSOSE_JFM_avg(ii,jj) = NaN;
            ETAN_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            ETAN_BSOSE_JJA_std(ii,jj) = NaN;
            ETAN_BSOSE_JJASON_std(ii,jj) = NaN;
            ETAN_BSOSE_DN_std(ii,jj) = NaN;
            ETAN_BSOSE_DJF_std(ii,jj) = NaN;
            ETAN_BSOSE_DJFMAM_std(ii,jj) = NaN;
            ETAN_BSOSE_JAS_std(ii,jj) = NaN;
            ETAN_BSOSE_JASOND_std(ii,jj) = NaN;
            ETAN_BSOSE_JD_std(ii,jj) = NaN;
            ETAN_BSOSE_JFM_std(ii,jj) = NaN;
            ETAN_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            MLD_BSOSE_JJA_avg(ii,jj) = NaN;
            MLD_BSOSE_JJASON_avg(ii,jj) = NaN;
            MLD_BSOSE_DN_avg(ii,jj) = NaN;
            MLD_BSOSE_DJF_avg(ii,jj) = NaN;
            MLD_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            MLD_BSOSE_JAS_avg(ii,jj) = NaN;
            MLD_BSOSE_JASOND_avg(ii,jj) = NaN;
            MLD_BSOSE_JD_avg(ii,jj) = NaN;
            MLD_BSOSE_JFM_avg(ii,jj) = NaN;
            MLD_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            MLD_BSOSE_JJA_std(ii,jj) = NaN;
            MLD_BSOSE_JJASON_std(ii,jj) = NaN;
            MLD_BSOSE_DN_std(ii,jj) = NaN;
            MLD_BSOSE_DJF_std(ii,jj) = NaN;
            MLD_BSOSE_DJFMAM_std(ii,jj) = NaN;
            MLD_BSOSE_JAS_std(ii,jj) = NaN;
            MLD_BSOSE_JASOND_std(ii,jj) = NaN;
            MLD_BSOSE_JD_std(ii,jj) = NaN;
            MLD_BSOSE_JFM_std(ii,jj) = NaN;
            MLD_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            WVEL_BSOSE_JJA_avg(ii,jj) = NaN;
            WVEL_BSOSE_JJASON_avg(ii,jj) = NaN;
            WVEL_BSOSE_DN_avg(ii,jj) = NaN;
            WVEL_BSOSE_DJF_avg(ii,jj) = NaN;
            WVEL_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            WVEL_BSOSE_JAS_avg(ii,jj) = NaN;
            WVEL_BSOSE_JASOND_avg(ii,jj) = NaN;
            WVEL_BSOSE_JD_avg(ii,jj) = NaN;
            WVEL_BSOSE_JFM_avg(ii,jj) = NaN;
            WVEL_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            WVEL_BSOSE_JJA_std(ii,jj) = NaN;
            WVEL_BSOSE_JJASON_std(ii,jj) = NaN;
            WVEL_BSOSE_DN_std(ii,jj) = NaN;
            WVEL_BSOSE_DJF_std(ii,jj) = NaN;
            WVEL_BSOSE_DJFMAM_std(ii,jj) = NaN;
            WVEL_BSOSE_JAS_std(ii,jj) = NaN;
            WVEL_BSOSE_JASOND_std(ii,jj) = NaN;
            WVEL_BSOSE_JD_std(ii,jj) = NaN;
            WVEL_BSOSE_JFM_std(ii,jj) = NaN;
            WVEL_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,13)==0)
            WVEL100_BSOSE_JJA_avg(ii,jj) = NaN;
            WVEL100_BSOSE_JJASON_avg(ii,jj) = NaN;
            WVEL100_BSOSE_DN_avg(ii,jj) = NaN;
            WVEL100_BSOSE_DJF_avg(ii,jj) = NaN;
            WVEL100_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            WVEL100_BSOSE_JAS_avg(ii,jj) = NaN;
            WVEL100_BSOSE_JASOND_avg(ii,jj) = NaN;
            WVEL100_BSOSE_JD_avg(ii,jj) = NaN;
            WVEL100_BSOSE_JFM_avg(ii,jj) = NaN;
            WVEL100_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            WVEL100_BSOSE_JJA_std(ii,jj) = NaN;
            WVEL100_BSOSE_JJASON_std(ii,jj) = NaN;
            WVEL100_BSOSE_DN_std(ii,jj) = NaN;
            WVEL100_BSOSE_DJF_std(ii,jj) = NaN;
            WVEL100_BSOSE_DJFMAM_std(ii,jj) = NaN;
            WVEL100_BSOSE_JAS_std(ii,jj) = NaN;
            WVEL100_BSOSE_JASOND_std(ii,jj) = NaN;
            WVEL100_BSOSE_JD_std(ii,jj) = NaN;
            WVEL100_BSOSE_JFM_std(ii,jj) = NaN;
            WVEL100_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,20)==0)
            WVEL190_BSOSE_JJA_avg(ii,jj) = NaN;
            WVEL190_BSOSE_JJASON_avg(ii,jj) = NaN;
            WVEL190_BSOSE_DN_avg(ii,jj) = NaN;
            WVEL190_BSOSE_DJF_avg(ii,jj) = NaN;
            WVEL190_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            WVEL190_BSOSE_JAS_avg(ii,jj) = NaN;
            WVEL190_BSOSE_JASOND_avg(ii,jj) = NaN;
            WVEL190_BSOSE_JD_avg(ii,jj) = NaN;
            WVEL190_BSOSE_JFM_avg(ii,jj) = NaN;
            WVEL190_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            WVEL190_BSOSE_JJA_std(ii,jj) = NaN;
            WVEL190_BSOSE_JJASON_std(ii,jj) = NaN;
            WVEL190_BSOSE_DN_std(ii,jj) = NaN;
            WVEL190_BSOSE_DJF_std(ii,jj) = NaN;
            WVEL190_BSOSE_DJFMAM_std(ii,jj) = NaN;
            WVEL190_BSOSE_JAS_std(ii,jj) = NaN;
            WVEL190_BSOSE_JASOND_std(ii,jj) = NaN;
            WVEL190_BSOSE_JD_std(ii,jj) = NaN;
            WVEL190_BSOSE_JFM_std(ii,jj) = NaN;
            WVEL190_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,25)==0)
            WVEL290_BSOSE_JJA_avg(ii,jj) = NaN;
            WVEL290_BSOSE_JJASON_avg(ii,jj) = NaN;
            WVEL290_BSOSE_DN_avg(ii,jj) = NaN;
            WVEL290_BSOSE_DJF_avg(ii,jj) = NaN;
            WVEL290_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            WVEL290_BSOSE_JAS_avg(ii,jj) = NaN;
            WVEL290_BSOSE_JASOND_avg(ii,jj) = NaN;
            WVEL290_BSOSE_JD_avg(ii,jj) = NaN;
            WVEL290_BSOSE_JFM_avg(ii,jj) = NaN;
            WVEL290_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            WVEL290_BSOSE_JJA_std(ii,jj) = NaN;
            WVEL290_BSOSE_JJASON_std(ii,jj) = NaN;
            WVEL290_BSOSE_DN_std(ii,jj) = NaN;
            WVEL290_BSOSE_DJF_std(ii,jj) = NaN;
            WVEL290_BSOSE_DJFMAM_std(ii,jj) = NaN;
            WVEL290_BSOSE_JAS_std(ii,jj) = NaN;
            WVEL290_BSOSE_JASOND_std(ii,jj) = NaN;
            WVEL290_BSOSE_JD_std(ii,jj) = NaN;
            WVEL290_BSOSE_JFM_std(ii,jj) = NaN;
            WVEL290_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,30)==0)
            WVEL475_BSOSE_JJA_avg(ii,jj) = NaN;
            WVEL475_BSOSE_JJASON_avg(ii,jj) = NaN;
            WVEL475_BSOSE_DN_avg(ii,jj) = NaN;
            WVEL475_BSOSE_DJF_avg(ii,jj) = NaN;
            WVEL475_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            WVEL475_BSOSE_JAS_avg(ii,jj) = NaN;
            WVEL475_BSOSE_JASOND_avg(ii,jj) = NaN;
            WVEL475_BSOSE_JD_avg(ii,jj) = NaN;
            WVEL475_BSOSE_JFM_avg(ii,jj) = NaN;
            WVEL475_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            WVEL475_BSOSE_JJA_std(ii,jj) = NaN;
            WVEL475_BSOSE_JJASON_std(ii,jj) = NaN;
            WVEL475_BSOSE_DN_std(ii,jj) = NaN;
            WVEL475_BSOSE_DJF_std(ii,jj) = NaN;
            WVEL475_BSOSE_DJFMAM_std(ii,jj) = NaN;
            WVEL475_BSOSE_JAS_std(ii,jj) = NaN;
            WVEL475_BSOSE_JASOND_std(ii,jj) = NaN;
            WVEL475_BSOSE_JD_std(ii,jj) = NaN;
            WVEL475_BSOSE_JFM_std(ii,jj) = NaN;
            WVEL475_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
        if (HC(ii,jj,36)==0)
            WVEL950_BSOSE_JJA_avg(ii,jj) = NaN;
            WVEL950_BSOSE_JJASON_avg(ii,jj) = NaN;
            WVEL950_BSOSE_DN_avg(ii,jj) = NaN;
            WVEL950_BSOSE_DJF_avg(ii,jj) = NaN;
            WVEL950_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            WVEL950_BSOSE_JAS_avg(ii,jj) = NaN;
            WVEL950_BSOSE_JASOND_avg(ii,jj) = NaN;
            WVEL950_BSOSE_JD_avg(ii,jj) = NaN;
            WVEL950_BSOSE_JFM_avg(ii,jj) = NaN;
            WVEL950_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            WVEL950_BSOSE_JJA_std(ii,jj) = NaN;
            WVEL950_BSOSE_JJASON_std(ii,jj) = NaN;
            WVEL950_BSOSE_DN_std(ii,jj) = NaN;
            WVEL950_BSOSE_DJF_std(ii,jj) = NaN;
            WVEL950_BSOSE_DJFMAM_std(ii,jj) = NaN;
            WVEL950_BSOSE_JAS_std(ii,jj) = NaN;
            WVEL950_BSOSE_JASOND_std(ii,jj) = NaN;
            WVEL950_BSOSE_JD_std(ii,jj) = NaN;
            WVEL950_BSOSE_JFM_std(ii,jj) = NaN;
            WVEL950_BSOSE_JFMAMJ_std(ii,jj) = NaN;
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            SALT_BSOSE_DJF_avg(ii,jj) = NaN;
	        SALT_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SALT_BSOSE_DN_avg(ii,jj) = NaN;
            SALT_BSOSE_JJA_avg(ii,jj) = NaN;
            SALT_BSOSE_JAS_avg(ii,jj) = NaN;
            SALT_BSOSE_JJASON_avg(ii,jj) = NaN;
            SALT_BSOSE_JASOND_avg(ii,jj) = NaN;
            SALT_BSOSE_JFM_avg(ii,jj) = NaN;
            SALT_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SALT_BSOSE_JD_avg(ii,jj) = NaN;           
        end
        if (HC(ii,jj,13)==0)
            SALT105_BSOSE_DJF_avg(ii,jj) = NaN;
	        SALT105_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SALT105_BSOSE_DN_avg(ii,jj) = NaN;
            SALT105_BSOSE_JJA_avg(ii,jj) = NaN;
            SALT105_BSOSE_JAS_avg(ii,jj) = NaN;
            SALT105_BSOSE_JJASON_avg(ii,jj) = NaN;
            SALT105_BSOSE_JASOND_avg(ii,jj) = NaN;
            SALT105_BSOSE_JFM_avg(ii,jj) = NaN;
            SALT105_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SALT105_BSOSE_JD_avg(ii,jj) = NaN;      
        end
        if (HC(ii,jj,20)==0)
            SALT200_BSOSE_DJF_avg(ii,jj) = NaN;
	        SALT200_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SALT200_BSOSE_DN_avg(ii,jj) = NaN;
            SALT200_BSOSE_JJA_avg(ii,jj) = NaN;
            SALT200_BSOSE_JAS_avg(ii,jj) = NaN;
            SALT200_BSOSE_JJASON_avg(ii,jj) = NaN;
            SALT200_BSOSE_JASOND_avg(ii,jj) = NaN;
            SALT200_BSOSE_JFM_avg(ii,jj) = NaN;
            SALT200_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SALT200_BSOSE_JD_avg(ii,jj) = NaN;        
        end
        if (HC(ii,jj,25)==0)
            SALT300_BSOSE_DJF_avg(ii,jj) = NaN;
	        SALT300_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SALT300_BSOSE_DN_avg(ii,jj) = NaN;
            SALT300_BSOSE_JJA_avg(ii,jj) = NaN;
            SALT300_BSOSE_JAS_avg(ii,jj) = NaN;
            SALT300_BSOSE_JJASON_avg(ii,jj) = NaN;
            SALT300_BSOSE_JASOND_avg(ii,jj) = NaN;
            SALT300_BSOSE_JFM_avg(ii,jj) = NaN;
            SALT300_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SALT300_BSOSE_JD_avg(ii,jj) = NaN;          
        end
        if (HC(ii,jj,30)==0)
            SALT500_BSOSE_DJF_avg(ii,jj) = NaN;
	        SALT500_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SALT500_BSOSE_DN_avg(ii,jj) = NaN;
            SALT500_BSOSE_JJA_avg(ii,jj) = NaN;
            SALT500_BSOSE_JAS_avg(ii,jj) = NaN;
            SALT500_BSOSE_JJASON_avg(ii,jj) = NaN;
            SALT500_BSOSE_JASOND_avg(ii,jj) = NaN;
            SALT500_BSOSE_JFM_avg(ii,jj) = NaN;
            SALT500_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SALT500_BSOSE_JD_avg(ii,jj) = NaN;       
        end
        if (HC(ii,jj,36)==0)
            SALT1000_BSOSE_DJF_avg(ii,jj) = NaN;
	        SALT1000_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SALT1000_BSOSE_DN_avg(ii,jj) = NaN;
            SALT1000_BSOSE_JJA_avg(ii,jj) = NaN;
            SALT1000_BSOSE_JAS_avg(ii,jj) = NaN;
            SALT1000_BSOSE_JJASON_avg(ii,jj) = NaN;
            SALT1000_BSOSE_JASOND_avg(ii,jj) = NaN;
            SALT1000_BSOSE_JFM_avg(ii,jj) = NaN;
            SALT1000_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SALT1000_BSOSE_JD_avg(ii,jj) = NaN;      
        end
        if (HC(ii,jj,42)==0)
            SALT2000_BSOSE_DJF_avg(ii,jj) = NaN;
	        SALT2000_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SALT2000_BSOSE_DN_avg(ii,jj) = NaN;
            SALT2000_BSOSE_JJA_avg(ii,jj) = NaN;
            SALT2000_BSOSE_JAS_avg(ii,jj) = NaN;
            SALT2000_BSOSE_JJASON_avg(ii,jj) = NaN;
            SALT2000_BSOSE_JASOND_avg(ii,jj) = NaN;
            SALT2000_BSOSE_JFM_avg(ii,jj) = NaN;
            SALT2000_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SALT2000_BSOSE_JD_avg(ii,jj) = NaN;            
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            TFLUX_BSOSE_DJF_avg(ii,jj) = NaN;
	        TFLUX_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            TFLUX_BSOSE_DN_avg(ii,jj) = NaN;
            TFLUX_BSOSE_JJA_avg(ii,jj) = NaN;
            TFLUX_BSOSE_JAS_avg(ii,jj) = NaN;
            TFLUX_BSOSE_JJASON_avg(ii,jj) = NaN;
            TFLUX_BSOSE_JASOND_avg(ii,jj) = NaN;
            TFLUX_BSOSE_JFM_avg(ii,jj) = NaN;
            TFLUX_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            TFLUX_BSOSE_JD_avg(ii,jj) = NaN;          
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            SFLUX_BSOSE_DJF_avg(ii,jj) = NaN;
	        SFLUX_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            SFLUX_BSOSE_DN_avg(ii,jj) = NaN;
            SFLUX_BSOSE_JJA_avg(ii,jj) = NaN;
            SFLUX_BSOSE_JAS_avg(ii,jj) = NaN;
            SFLUX_BSOSE_JJASON_avg(ii,jj) = NaN;
            SFLUX_BSOSE_JASOND_avg(ii,jj) = NaN;
            SFLUX_BSOSE_JFM_avg(ii,jj) = NaN;
            SFLUX_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            SFLUX_BSOSE_JD_avg(ii,jj) = NaN;          
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            CFLUX_BSOSE_DJF_avg(ii,jj) = NaN;
	        CFLUX_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            CFLUX_BSOSE_DN_avg(ii,jj) = NaN;
            CFLUX_BSOSE_JJA_avg(ii,jj) = NaN;
            CFLUX_BSOSE_JAS_avg(ii,jj) = NaN;
            CFLUX_BSOSE_JJASON_avg(ii,jj) = NaN;
            CFLUX_BSOSE_JASOND_avg(ii,jj) = NaN;
            CFLUX_BSOSE_JFM_avg(ii,jj) = NaN;
            CFLUX_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            CFLUX_BSOSE_JD_avg(ii,jj) = NaN;          
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            OFLUX_BSOSE_DJF_avg(ii,jj) = NaN;
	        OFLUX_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            OFLUX_BSOSE_DN_avg(ii,jj) = NaN;
            OFLUX_BSOSE_JJA_avg(ii,jj) = NaN;
            OFLUX_BSOSE_JAS_avg(ii,jj) = NaN;
            OFLUX_BSOSE_JJASON_avg(ii,jj) = NaN;
            OFLUX_BSOSE_JASOND_avg(ii,jj) = NaN;
            OFLUX_BSOSE_JFM_avg(ii,jj) = NaN;
            OFLUX_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            OFLUX_BSOSE_JD_avg(ii,jj) = NaN;          
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            DIC_BSOSE_DJF_avg(ii,jj) = NaN;
	        DIC_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            DIC_BSOSE_DN_avg(ii,jj) = NaN;
            DIC_BSOSE_JJA_avg(ii,jj) = NaN;
            DIC_BSOSE_JAS_avg(ii,jj) = NaN;
            DIC_BSOSE_JJASON_avg(ii,jj) = NaN;
            DIC_BSOSE_JASOND_avg(ii,jj) = NaN;
            DIC_BSOSE_JFM_avg(ii,jj) = NaN;
            DIC_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            DIC_BSOSE_JD_avg(ii,jj) = NaN;          
        end
    end
end
...
for ii=1:m64
    for jj=1:n64
        if (HC(ii,jj,1)==0)
            ALK_BSOSE_DJF_avg(ii,jj) = NaN;
	        ALK_BSOSE_DJFMAM_avg(ii,jj) = NaN;
            ALK_BSOSE_DN_avg(ii,jj) = NaN;
            ALK_BSOSE_JJA_avg(ii,jj) = NaN;
            ALK_BSOSE_JAS_avg(ii,jj) = NaN;
            ALK_BSOSE_JJASON_avg(ii,jj) = NaN;
            ALK_BSOSE_JASOND_avg(ii,jj) = NaN;
            ALK_BSOSE_JFM_avg(ii,jj) = NaN;
            ALK_BSOSE_JFMAMJ_avg(ii,jj) = NaN;
            ALK_BSOSE_JD_avg(ii,jj) = NaN;          
        end
    end
end
