...
acc_quad_plots_v8
hold off
print('WVEL100_AVG_07JJASON','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL100_AVG_08JASOND','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL100_AVG_04JFMAMJ','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL100_AVG_03DJFMAM','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL190_AVG_07JJASON','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL190_AVG_08JASOND','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL190_AVG_04JFMAMJ','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL190_AVG_03DJFMAM','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL290_AVG_07JJASON','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL290_AVG_08JASOND','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL290_AVG_04JFMAMJ','-dpng')
close all
%% END WVEL
...
acc_quad_plots_v8
hold off
print('WVEL290_AVG_03DJFMAM','-dpng')
close all
%% END WVEL
