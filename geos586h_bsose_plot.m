...
THETA_mean(hFacC==0)=25.2;
THETA_JFM(hFacC==0)=25.2;
THETA_AMJ(hFacC==0)=25.2;
THETA_JAS(hFacC==0)=25.2;
THETA_OND(hFacC==0)=25.2;
...
xtickformat('degrees')
ytickformat('degrees')
title('BSOSE vs Argo average temperature of top 20m, 2005 - 2018','FontWeight','Normal')
acc_movie
acc_plots
...
xtickformat('degrees')
ytickformat('degrees')
title('BSOSE vs Argo average temperature of top 20m in JFM, 2005 - 2018','FontWeight','Normal')
acc_movie
acc_plots
...
xtickformat('degrees')
ytickformat('degrees')
title('BSOSE vs Argo average temperature of top 20m in AMJ, 2005 - 2018','FontWeight','Normal')
acc_movie
acc_plots
...
xtickformat('degrees')
ytickformat('degrees')
title('BSOSE vs Argo average temperature of top 20m in JAS, 2005 - 2018','FontWeight','Normal')
acc_movie
acc_plots
...
xtickformat('degrees')
ytickformat('degrees')
title('BSOSE vs Argo average temperature of top 20m in OND, 2005 - 2018','FontWeight','Normal')
acc_movie
acc_plots
