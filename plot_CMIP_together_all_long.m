...
figure()
set(gcf, 'Position', [1, 1, 1600, 1300])
ax1 = subplot(1,2,1);
plot(13.8.*ones(50),linspace(0.1,49.97,50),'LineWidth',83,'Color',[0.7,0.7,0.7,0.04])
hold on
plot(9.27.*ones(50),linspace(0.1,49.97,50),'LineWidth',1.5,'Color','k')
plot(18.33.*ones(50),linspace(0.1,49.97,50),'LineWidth',1.5,'Color','k')
...
ax2 = subplot(1,2,2);
plot(26.2.*ones(50),linspace(0.1,49.96,50),'LineWidth',107,'Color',[0.7,0.7,0.7,0.04])
hold on
plot(30.8.*ones(50),linspace(0.1,49.96,50),'LineWidth',1.5,'Color','k')
plot(21.6.*ones(50),linspace(0.1,49.96,50),'LineWidth',1.5,'Color','k')
