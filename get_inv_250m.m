...
Heat_250m_TS_3 = zeros(192,132,365);
Heat_250m_TS_6 = zeros(384,260,365);
Heat_250m_TS_12 = zeros(756,512,365);

Carbon_250m_TS_3 = zeros(192,132,365);
Carbon_250m_TS_6 = zeros(384,260,365);
Carbon_250m_TS_12 = zeros(756,512,365);
...
for ii=1:192
    for jj=1:132
        if (hFacC3(ii,jj,1)==0)
            Heat_250m_TS_3(ii,jj) = NaN;
            Carbon_250m_TS_3(ii,jj) = NaN;
        end
    end
end
...
for ii=1:384
    for jj=1:260
        if (hFacC6(ii,jj,1)==0)
            Heat_250m_TS_6(ii,jj) = NaN;
            Carbon_250m_TS_6(ii,jj) = NaN;
        end
    end
end
...
for ii=1:756
    for jj=1:512
        if (hFacC12(ii,jj,1)==0)
            Heat_250m_TS_12(ii,jj) = NaN;
            Carbon_250m_TS_12(ii,jj) = NaN;
        end
    end
end

Heat_250m_mean_3 = mean(Heat_250m_TS_3,3);
Heat_250m_std_3 = std(Heat_250m_TS_3,0,3);
Heat_250m_mean_6 = mean(Heat_250m_TS_6,3);
Heat_250m_std_6 = std(Heat_250m_TS_6,0,3);
Heat_250m_mean_12 = mean(Heat_250m_TS_12,3);
Heat_250m_std_12 = std(Heat_250m_TS_12,0,3);

clear Heat_250m_TS*
save Heat_250m_mean_std Heat_250m_mean* Heat_250m_std*
clear Heat*

Carbon_250m_mean_3 = mean(Carbon_250m_TS_3,3);
Carbon_250m_std_3 = std(Carbon_250m_TS_3,0,3);
Carbon_250m_mean_6 = mean(Carbon_250m_TS_6,3);
Carbon_250m_std_6 = std(Carbon_250m_TS_6,0,3);
Carbon_250m_mean_12 = mean(Carbon_250m_TS_12,3);
Carbon_250m_std_12 = std(Carbon_250m_TS_12,0,3);

clear Carbon_250m_TS*
save Carbon_250m_mean_std Carbon_250m_mean* Carbon_250m_std*
clear Carbon*
