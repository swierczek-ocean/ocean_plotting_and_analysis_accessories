...
Obs_250_temp = [time,lat,lon+360,theta,salt];
Obs_250_temp = sortrows(Obs_250_temp,1);

start_date = 20161130;

start = find(Obs_250_temp(:,1)>start_date,1);

Obs_250_temp = Obs_250_temp(start:end,:);
...
for ii=1:396
    ...
    Obs_250(ii,:) = mean(Obs_250_temp(Obs_250_temp(:,1)==date_n,:),1);
    date = date+1;
end

clearvars -except Obs_250
