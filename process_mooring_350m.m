...
Obs_350_temp = [time,lat,lon+360,theta,salt];
Obs_350_temp = sortrows(Obs_350_temp,1);

start_date = 20161130;

start = find(Obs_350_temp(:,1)>start_date,1);

Obs_350_temp = Obs_350_temp(start:end,:);
...
for ii=1:396
    ...
    Obs_350(ii,:) = mean(Obs_350_temp(Obs_350_temp(:,1)==date_n,:),1);
    date = date+1;
end

clearvars -except Obs_350
